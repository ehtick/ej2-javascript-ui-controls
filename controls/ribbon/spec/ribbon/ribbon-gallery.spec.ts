...
describe('Ribbon', () => {
    ...
    describe('Ribbon gallery', () => {
        ...
        it('should align popup left without wrapper style (auto width)', (done) => {
            ...
            setTimeout(() => {
                ...
                const popup = document.querySelector('.e-dropdown-popup.e-ribbon-gallery-dropdown') as HTMLElement;
                const galleryContainer = popup.querySelector('.e-ribbon-gallery-container') as HTMLElement;

                expect(galleryContainer.style.flexFlow).not.toContain('column');

                const popupLeft = parseFloat(window.getComputedStyle(popup).left);
                const buttonRect = dropdown.getBoundingClientRect();
                const popupWidth = popup.offsetWidth;

                let expectedLeft = buttonRect.left - popupWidth - 1;
                if (expectedLeft < 0) expectedLeft = 1;

                expect(Math.abs(popupLeft - expectedLeft)).toBeLessThanOrEqual(1);
        ...
        it('should apply wrapper style and align popup left (with popupWidth)', (done) => {
            ...
            setTimeout(() => {
                ...
                expect(galleryContainer.style.flexFlow).toContain('column wrap');
