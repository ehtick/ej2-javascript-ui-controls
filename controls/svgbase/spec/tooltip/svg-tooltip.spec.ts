...
import { removeElement, getElement, findDirection, Rect, TooltipLocation } from '../../src/tooltip/helper';
...
describe('SVG Tooltip', () => {
    ...
    it('tooltip checking for shared tooltip animation', function () {
        tooltip.loaded = function (arsgs) {
            tooltip.inverted = false;
            tooltip.controlName = 'Chart';
            tooltip.tooltipLocation({x:10, y:25, height:85, width: 65}, {x: -10, y: 10}, {x: 76, y: 10}, {x:10, y:10});
            tooltip.tooltipLocation({x:20, y:35, height:95, width: 75}, {x: -20, y: 20}, {x: 86, y: 20}, {x:20, y:20});
            expect(true).toBe(true);
        };
        tooltip.shared = true;
        tooltip.enableAnimation = true;
    ...
    it('Checking split tooltip with bottom boundary collision detection', () => {
        tooltip.loaded = (args: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);

            const groupFirst: Element = document.getElementById('tooltipcontainer_group_0');
            const groupSecond: Element = document.getElementById('tooltipcontainer_group_1');
            const groupThird: Element = document.getElementById('tooltipcontainer_group_2');

            expect(groupFirst).not.toBe(null);
            expect(groupSecond).not.toBe(null);
            expect(groupThird).not.toBe(null);

            expect((groupFirst as HTMLElement).style.transform).toBe('translate(116.667px, 7px)');
            expect((groupSecond as HTMLElement).style.transform).toBe('translate(116.667px, 58px)');
            expect((groupThird as HTMLElement).style.transform).toBe('translate(116.667px, 89px)');

            const pathFirst: Element = document.getElementById('tooltipcontainer_path_0');
            const pathSecond: Element = document.getElementById('tooltipcontainer_path_1');
            const pathThird: Element = document.getElementById('tooltipcontainer_path_2');
            expect(pathFirst).not.toBe(null);
            expect(pathSecond).not.toBe(null);
            expect(pathThird).not.toBe(null);

            expect(pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 90 26 Q 94 26 94 22 L 94 4 Q 94 0 90 0 z' || pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 93 26 Q 97 26 97 22 L 97 4 Q 97 0 93 0 z' || pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 95 26 Q 99 26 99 22 L 99 4 Q 99 0 95 0 z').toBe(true);
            expect(pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 104 26 Q 108 26 108 22 L 108 4 Q 108 0 104 0 z' || pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 104 26 Q 108 26 108 22 L 108 4 Q 108 0 104 0 z').toBe(true);
            expect(pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 95 26 Q 99 26 99 22 L 99 4 Q 99 0 95 0 z' || pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 95 26 Q 99 26 99 22 L 99 4 Q 99 0 95 0 z').toBe(true);

            const textFirst: Element = document.getElementById('tooltipcontainer_text_0');
            const textSecond: Element = document.getElementById('tooltipcontainer_text_1');
            const textThird: Element = document.getElementById('tooltipcontainer_text_2');
            expect(textFirst).not.toBe(null);
            expect(textSecond).not.toBe(null);
            expect(textThird).not.toBe(null);

            const connectorFirst: Element = document.getElementById('tooltipcontainer_tooltip_connector_0');
            const connectorSecond: Element = document.getElementById('tooltipcontainer_tooltip_connector_1');

            if (connectorFirst) {
                expect(connectorFirst.getAttribute('d')).toBe('M -16.66666666666667 52 L 0 13');
            }
            if (connectorSecond) {
                expect(connectorSecond.getAttribute('d')).toBe('M -16.66666666666667 52 L 0 13');
            }
        };
        ...
        tooltip.shared = false;
        tooltip.inverted = false;
        tooltip.content = ['First Tooltip', 'Second Tooltip', 'Third Tooltip'];
        tooltip.shapes = ['Circle', 'Diamond', 'Circle'];
        tooltip.palette = ['red', 'blue', 'Green'];
        (tooltip.splitClipBounds as Rect[]) = [{ x: 0, y: 0, width: 400, height: 120 }, { x: 0, y: 0, width: 400, height: 120 }, { x: 0, y: 0, width: 400, height: 120 }];
        tooltip.areaBounds = { x: 0, y: 0, width: 500, height: 300 };
        tooltip.splitLocations = [{ x: 100, y: 20 }, { x: 100, y: 110 }, { x: 90, y: 120 }];
        tooltip.template = null;
        tooltip.controlName = 'Chart';
    ...
    it('Checking split tooltip with top boundary collision detection', () => {
        tooltip.loaded = (args: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            ...
            expect((groupFirst as HTMLElement).style.transform).toBe('translate(116.667px, 5px)');
            expect((groupSecond as HTMLElement).style.transform).toBe('translate(116.667px, 36px)');
            expect((groupThird as HTMLElement).style.transform).toBe('translate(116.667px, 107px)');
            ...
            expect(pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 93 26 Q 97 26 97 22 L 97 4 Q 97 0 93 0 z' || pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 90 26 Q 94 26 94 22 L 94 4 Q 94 0 90 0 z' || pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 95 26 Q 99 26 99 22 L 99 4 Q 99 0 95 0 z').toBe(true);
            expect(pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 109 26 Q 113 26 113 22 L 113 4 Q 113 0 109 0 z' || pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 22 Q 0 26 4 26 L 104 26 Q 108 26 108 22 L 108 4 Q 108 0 104 0 z').toBe(true);
            expect(pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 98 26 Q 102 26 102 22 L 102 4 Q 102 0 98 0 z' || pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 13 L 0 13 L 0 13 L 0 22 Q 0 26 4 26 L 95 26 Q 99 26 99 22 L 99 4 Q 99 0 95 0 z').toBe(true);
            ...
            if (connectorFirst) {
                expect(connectorFirst.getAttribute('d')).toBe('M -16.66666666666667 -5 L 0 13');
            }
            if (connectorSecond) {
                expect(connectorSecond.getAttribute('d')).toBe('M -16.66666666666667 -26 L 0 13');
            }
        };
        ...
        tooltip.shapes = ['Circle', 'Diamond', 'Circle'];
        tooltip.palette = ['red', 'blue', 'Green'];
        (tooltip.splitClipBounds as Rect[]) = [{ x: 0, y: 0, width: 400, height: 400 }, { x: 0, y: 0, width: 400, height: 400 }, { x: 0, y: 0, width: 400, height: 400 }];
        tooltip.areaBounds = { x: 0, y: 0, width: 500, height: 500 };
        tooltip.splitLocations = [{ x: 100, y: 0 }, { x: 100, y: 10 }, { x: 90, y: 120 }];
        tooltip.template = null;
        tooltip.controlName = 'Chart';
        tooltip.enableRTL = false;
        tooltip.refresh();
    ...
    it('Checking split tooltip with right boundary collision detection', () => {
        tooltip.loaded = (args: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            ...
            expect((groupFirst as HTMLElement).style.transform === 'translate(3.66667px, 5px)' || (groupFirst as HTMLElement).style.transform === 'translate(4.66667px, 5px)').toBe(true);
            expect((groupSecond as HTMLElement).style.transform === 'translate(-7.33333px, 58px)' || (groupSecond as HTMLElement).style.transform === 'translate(-3.33333px, 58px)').toBe(true);
            expect((groupThird as HTMLElement).style.transform === 'translate(-1.33333px, 146.5px)' || (groupThird as HTMLElement).style.transform === 'translate(-0.333333px, 146.5px)').toBe(true);
            ...
            expect(pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 69 48 Q 73 48 73 44 L 73 4 Q 73 0 69 0 z' || pathFirst.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 68 48 Q 72 48 72 44 L 72 4 Q 72 0 68 0 z').toBe(true);
            expect(pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 80 48 Q 84 48 84 44 L 84 4 Q 84 0 80 0 z' || pathSecond.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 76 48 Q 80 48 80 44 L 80 4 Q 80 0 76 0 z').toBe(true);
            expect(pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 74 48 Q 78 48 78 44 L 78 4 Q 78 0 74 0 z' || pathThird.getAttribute('d') === 'M 4 0 Q 0 0 0 4 L 0 0 L 0 0 L 0 0 L 0 44 Q 0 48 4 48 L 73 48 Q 77 48 77 44 L 77 4 Q 77 0 73 0 z').toBe(true);
            ...
            if (connectorFirst) {
                expect(connectorFirst.getAttribute('d') === 'M 96.33333333333333 -5 L 73 24' || connectorFirst.getAttribute('d') === 'M 95.33333333333333 -5 L 72 24').toBe(true);
            }
            if (connectorSecond) {
                expect(connectorSecond.getAttribute('d') === 'M 107.33333333333333 -48 L 84 24' || connectorSecond.getAttribute('d') === 'M 103.33333333333333 -48 L 80 24').toBe(true);
            }
        };
        ...
        tooltip.palette = ['red', 'blue', 'Green'];
        (tooltip.splitClipBounds as Rect[]) = [{ x: 0, y: 0, width: 400, height: 400 }, { x: 0, y: 0, width: 400, height: 400 }, { x: 0, y: 0, width: 400, height: 400 }];
        tooltip.areaBounds = { x: 0, y: 0, width: 100, height: 500 };
        tooltip.splitLocations = [{ x: 100, y: 0 }, { x: 100, y: 10 }, { x: 90, y: 120 }];
        tooltip.template = null;
        tooltip.controlName = 'Chart';
        tooltip.enableRTL = false;
    ...
    it('Checking creation, transform and removal of split tooltip groups and paths', (done: Function) => {
        let stage: number = 0;
        tooltip.loaded = (args: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            ...
            if (stage === 0) {
                ...
                expect(groupFirst).not.toBe(null);
                expect(groupFirst.getAttribute('transform')).toBe('translate(0,0)');
                expect(pathFirst).not.toBe(null);

                stage = 1;
                tooltip.content = ['Only Tooltip'];
                tooltip.refresh();
            } else {

                expect(document.getElementById('tooltipcontainer_group_0')).not.toBe(null);
                expect(document.getElementById('tooltipcontainer_group_1')).toBe(null);
                expect(document.getElementById('tooltipcontainer_group_2')).toBe(null);

                expect(document.getElementById('tooltipcontainer_path_1')).toBe(null);
                expect(document.getElementById('tooltipcontainer_path_2')).toBe(null);

                expect(document.getElementById('tooltipcontainer_tooltip_connector_1')).toBe(null);
                expect(document.getElementById('tooltipcontainer_tooltip_connector_2')).toBe(null);
                done();
            }
        };
        tooltip.inverted = false;
        tooltip.split = true;
        tooltip.shared = false;
        tooltip.content = ['First', 'Second', 'Third'];
        tooltip.shapes = ['Circle', 'Circle', 'Circle'];
        tooltip.palette = ['red', 'blue', 'green'];
        tooltip.splitLocations = [{ x: 10, y: 10 }, { x: 20, y: 20 }, { x: 30, y: 30 }];
        tooltip.template = null;
        tooltip.refresh();
    });
    it('FollowPointer should update tooltip position when location changes', (done: Function) => {
        tooltip.loaded = () => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            const group = document.getElementById('tooltipcontainer_group');
            expect(group).not.toBe(null);
            expect(svgObject.parentElement.style.left).toBe('66px');
            expect(svgObject.parentElement.style.top).toBe('23px');
            done();
        };
        tooltip.inverted = false;
        tooltip.followPointer = true;
        tooltip.location = { x: 200, y: 100 };
        tooltip.clipBounds = { x: 0, y: 0, width: 400, height: 400 } as TooltipLocation
        tooltip.content = ['FollowPointer Tooltip'];
        tooltip.shared = false;
        tooltip.split = false;
        tooltip.template = null;
        tooltip.refresh();
    ...
    it('Checking split Template', function () {
        tooltip.loaded = function (args: Object) {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).toBe(null);
            const parentEl = document.getElementById('tooltipcontainerparent_template0') || document.getElementById('tooltipcontainerparent_template_0');
            expect(parentEl).not.toBe(null);
            if (parentEl) {
                const firstDiv = parentEl.querySelector('div');
                expect(firstDiv).not.toBe(null);
                expect((firstDiv as HTMLElement).innerText.indexOf('10') > -1).toBe(true);
                removeElement(parentEl.id);
            }
        };
        tooltip.template = '<div>${x}:</div><div>${y}</div>';
        tooltip.data = [{ x: 10, y: 56 }];
    ...
    it('Sankey chart tooltip with RTL and single colon', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
            expect(text).not.toBe(null);
            expect(text.childElementCount).toBeGreaterThan(0);
        };
        tooltip.split = false;
        tooltip.tooltipRender = null;
        tooltip.template = null;
        ...
        tooltip.animationComplete = null;
        tooltip.enableRTL = true;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['Source : <b>Value</b>'];
        tooltip.header = 'Sankey Flow';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    });

    it('Sankey chart tooltip with RTL and multiple colons', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
        ...
        tooltip.enableRTL = true;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['Source : Target : <b>Value</b>'];
        tooltip.header = 'Sankey Flow';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    ...
    it('Sankey chart tooltip without RTL', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
        ...
        tooltip.enableRTL = false;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['Source : <b>Target</b>'];
        tooltip.header = 'Sankey Flow';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    ...
    it('Sankey chart tooltip with RTL but no colon', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
        ...
        tooltip.enableRTL = true;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['<b>Simple Text</b>'];
        tooltip.header = 'Sankey Flow';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    ...
    it('Sankey chart tooltip with RTL and arabic text with single colon', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
        ...
        tooltip.enableRTL = true;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['مصدر : <b>3M</b>'];
        tooltip.header = 'تدفق سانكي';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    });

    it('Sankey chart tooltip RTL positioning with updateDiv', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            const tooltipDiv: HTMLElement = document.getElementById('tooltipcontainer');
            expect(tooltipDiv).not.toBe(null);
            expect(tooltipDiv.style.right).toBeTruthy();
        };
        tooltip.split = false;
        tooltip.tooltipRender = null;
        tooltip.template = null;
    ...
    it('Sankey chart tooltip with RTL animation', (done: Function) => {
        tooltip.animationComplete = (args: ITooltipAnimationCompleteArgs) => {
            const tooltipDiv: HTMLElement = document.getElementById('tooltipcontainer');
            expect(tooltipDiv).not.toBe(null);
            expect(tooltipDiv.style.right).toBeTruthy();
        ...
        tooltip.template = null;
        tooltip.loaded = null;
        tooltip.location = { x: 300, y: 300 };
        tooltip.inverted = false;
        tooltip.enableAnimation = true;
        tooltip.shared = false;
        tooltip.enableRTL = true;
        tooltip.controlName = 'Sankey';
        tooltip.content = ['Animated : <b>Value</b>'];
        tooltip.header = 'Sankey';
        tooltip.shapes = ['Circle'];
        tooltip.areaBounds = { x: 0, y: 0, width: 500, height: 500 };
        tooltip.theme = 'Material';
        tooltip.refresh();
    ...
    it('Non-Sankey chart tooltip with RTL and single colon should reverse lines', () => {
        tooltip.loaded = (arsgs: Object) => {
            svgObject = getElement('tooltipcontainer_svg');
            expect(svgObject).not.toBe(null);
            let text: Element = document.getElementById('tooltipcontainer_text');
        ...
        tooltip.enableRTL = true;
        tooltip.controlName = 'Chart';
        tooltip.content = ['Label : <b>Value</b>'];
        tooltip.header = 'Chart Header';
        tooltip.shapes = ['Circle'];
        tooltip.theme = 'Material';
        tooltip.refresh();
    });
