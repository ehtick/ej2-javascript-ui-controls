...
$toast-close-icon-border-radius: 50% !default;
...
$toast-bgr-content-first-child-padding-bottom: 8px !default;
$toast-bgr-content-first-child-padding-left: 48px !default;
$toast-bgr-content-first-child-padding-right: 12px !default;
$toast-bgr-content-first-child-padding-top: 8px !default;
$toast-bgr-last-child-padding-bottom: 16px !default;
$toast-border: 1px !default;
$toast-bgr-actions-margin: 16px !default;
$toast-bgr-close-icon-margin-top: 13px !default;
$toast-bgr-close-icon-right: 12px !default;
$toast-bgr-toast-icon-margin-top: 14px !default;
$toast-bgr-toast-icon-margin-left: 12px !default;
$toast-content-first-child-padding-bottom: 8px !default;
$toast-content-first-child-padding-left: 12px !default;
$toast-content-first-child-padding-right: 12px !default;
$toast-content-first-child-padding-top: 8px !default;
$toast-content-last-padding-bottom: 12px !default;
$toast-actions-margin: 12px !default;
$toast-header-padding-left: 44px !default;
$toast-header-padding-right: 30px !default;
$toast-close-icon-margin-top: 13px !default;
$toast-close-icon-right: 8px !default;
$toast-icon-margin-left: 12px !default;
$toast-icon-top: 15px !default;
$toast-icon-padding-bottom: 6px !default;
