...
describe('1003529 - License validation', () => {
    it('default-sample-watermark', () => {
        ...
        const helveticaRef = result[242]._operands[0];
        ...
        expect(result[240]._operands.length).toBe(0);
        expect(result[241]._operator).toEqual('rg');
        expect(result[241]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[242]._operator).toEqual('Tf');
        expect(result[242]._operands[1]).toEqual('14.000');
        expect(result[243]._operator).toEqual('Tm');
        expect(result[243]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[244]._operator).toEqual("'");
        expect(result[244]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in)']);
        expect(result[245]._operator).toEqual('Tm');
        expect(result[245]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[246]._operator).toEqual("'");
        expect(result[246]._operands).toEqual(['(your application. To obtain the valid key, Click)']);
        expect(result[247]._operator).toEqual('ET');
        expect(result[247]._operands.length).toBe(0);
        expect(result[248]._operator).toEqual('BT');
        expect(result[248]._operands.length).toBe(0);
        expect(result[249]._operator).toEqual('rg');
        expect(result[249]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[250]._operator).toEqual('Tf');
        expect(result[251]._operator).toEqual('Tm');
        expect(result[251]._operands).toEqual(['1.00', '.00', '.00', '1.00', '329.00', '-39.22']);
        expect(result[252]._operator).toEqual("'");
        expect(result[252]._operands).toEqual(['(here)']);
        expect(result[253]._operator).toEqual('ET');
        expect(result[253]._operands.length).toBe(0);
        expect(result[254]._operator).toEqual('q');
        expect(result[254]._operands.length).toBe(0);
        expect(result[255]._operator).toEqual('Q');
        expect(result[255]._operands.length).toBe(0);
        expect(result[256]._operator).toEqual('q');
        expect(result[256]._operands.length).toBe(0);
        expect(result[257]._operator).toEqual('cm');
        expect(result[257]._operands).toEqual(['1.00', '.00', '.00', '1.00', '297.50', '-421.00']);
        expect(result[258]._operator).toEqual('gs');
        expect(result[259]._operator).toEqual('cm');
        expect(result[259]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[260]._operator).toEqual('BT');
        expect(result[260]._operands.length).toBe(0);
        expect(result[261]._operator).toEqual('rg');
        expect(result[261]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[262]._operator).toEqual('Tf');
        expect(result[263]._operator).toEqual('Tm');
        expect(result[263]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[264]._operator).toEqual("'");
        expect(result[264]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[265]._operator).toEqual('Td');
        expect(result[265]._operands).toEqual(['0.000', '141.442']);
        expect(result[266]._operator).toEqual('ET');
        expect(result[266]._operands.length).toBe(0);
        expect(result[267]._operator).toEqual('Q');
        expect(result[267]._operands.length).toBe(0);
        parsed.destroy();
    });
    it('Hello World Sample', () => {
        ...
        //Font check
        const fontDictionary: _PdfDictionary = parsedPage._pageDictionary.get('Resources').get('Font');
        const HelveticaRef: string = result[22]._operands[0];
        const Helvetica: _PdfName = fontDictionary.get(HelveticaRef.slice(1)).get('BaseFont');
        expect(result[20]._operator).toEqual('BT');
        expect(result[20]._operands.length).toBe(0);
        expect(result[21]._operator).toEqual('rg');
        expect(result[21]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[22]._operator).toEqual('Tf');
        expect(result[22]._operands[1]).toEqual('14.000');
        expect(result[23]._operator).toEqual('Tm');
        expect(result[23]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[24]._operator).toEqual("'");
        expect(result[24]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the)']);
        expect(result[25]._operator).toEqual('Tm');
        expect(result[25]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[26]._operator).toEqual("'");
        expect(result[26]._operands).toEqual(['(wrong key in your application. To obtain the valid key, Click)']);
        expect(result[27]._operator).toEqual('ET');
        expect(result[27]._operands.length).toBe(0);
        expect(result[28]._operator).toEqual('BT');
        expect(result[28]._operands.length).toBe(0);
        expect(result[29]._operator).toEqual('rg');
        expect(result[29]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[30]._operator).toEqual('Tf');
        expect(result[30]._operands[1]).toEqual('14.000');
        expect(result[31]._operator).toEqual('Tm');
        expect(result[31]._operands).toEqual(['1.00', '.00', '.00', '1.00', '411.48', '-39.22']);
        expect(result[32]._operator).toEqual("'");
        expect(result[32]._operands).toEqual(['(here)']);
        ...
        expect(result[37]._operands).toEqual(['1.00', '.00', '.00', '1.00', '257.50', '-381.00']);
        expect(result[38]._operator).toEqual('gs');
        expect(result[39]._operator).toEqual('cm');
        expect(result[39]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[40]._operator).toEqual('BT');
        expect(result[40]._operands.length).toBe(0);
        expect(result[41]._operator).toEqual('rg');
        expect(result[41]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[42]._operator).toEqual('Tf');
        expect(result[43]._operator).toEqual('Tm');
        expect(result[43]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[44]._operator).toEqual("'");
        expect(result[44]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[45]._operator).toEqual('Td');
        expect(result[45]._operands).toEqual(['0.000', '141.442']);
    ...
    رأس الصفحة هو ببساطة رقم إصدار PDF وتسلسل عشوائي للبيانات الثنائية. البيانات الثنائية تمنع التطبيقات الساذجة من معالجة ملف PDF كملف نصي. سيؤدي ذلك إلى ملف تالف ، لأن ملف PDF يتكون عادةً من نص عادي وبيانات ثنائية (على سبيل المثال ، يمكن تضمين ملف خط ثنائي بشكل مباشر في ملف PDF).`,
        ...
        expect(result[70]._operator).toEqual('BT');
        expect(result[70]._operands.length).toBe(0);
        expect(result[71]._operator).toEqual('rg');
        expect(result[71]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[72]._operator).toEqual('Tf');
        expect(result[72]._operands[1]).toEqual('14.000');
        expect(result[73]._operator).toEqual('Tm');
        expect(result[73]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[74]._operator).toEqual("'");
        expect(result[74]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the)']);
        expect(result[75]._operator).toEqual('Tm');
        expect(result[75]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[76]._operator).toEqual("'");
        expect(result[76]._operands).toEqual(['(wrong key in your application. To obtain the valid key, Click)']);
        expect(result[77]._operator).toEqual('ET');
        ...
        expect(result[79]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[80]._operator).toEqual('Tf');
        expect(result[80]._operands[1]).toEqual('14.000');
        expect(result[81]._operator).toEqual('Tm');
        expect(result[81]._operands).toEqual(['1.00', '.00', '.00', '1.00', '411.48', '-39.22']);
        expect(result[82]._operator).toEqual("'");
        expect(result[82]._operands).toEqual(['(here)']);
        ...
        expect(result[85]._operator).toEqual('Q');
        expect(result[85]._operands.length).toBe(0);
        expect(result[86]._operator).toEqual('q');
        expect(result[86]._operands.length).toBe(0);
        expect(result[87]._operator).toEqual('cm');
        expect(result[87]._operands).toEqual(['1.00', '.00', '.00', '1.00', '257.50', '-381.00']);
        expect(result[88]._operator).toEqual('gs');
        expect(result[89]._operator).toEqual('cm');
        expect(result[89]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[90]._operator).toEqual('BT');
        expect(result[90]._operands.length).toBe(0);
        expect(result[91]._operator).toEqual('rg');
        expect(result[91]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[92]._operator).toEqual('Tf');
        expect(result[93]._operator).toEqual('Tm');
        expect(result[93]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[94]._operator).toEqual("'");
        expect(result[94]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[95]._operator).toEqual('Td');
        expect(result[95]._operands).toEqual(['0.000', '141.442']);
        expect(result[96]._operator).toEqual('ET');
        expect(result[96]._operands.length).toBe(0);
        expect(result[97]._operator).toEqual('Q');
    ...
    it('Bullets And Lists', () => {
        ...
        const Helvetica: _PdfName = fontDictionary.get(HelveticaRef.slice(1)).get('BaseFont');
        expect(Helvetica.name).toEqual('Helvetica');
        expect(result[232]._operator).toEqual('BT');
        expect(result[232]._operands.length).toBe(0);
        expect(result[233]._operator).toEqual('rg');
        expect(result[233]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[234]._operator).toEqual('Tf');
        expect(result[234]._operands[1]).toEqual('14.000');
        expect(result[235]._operator).toEqual('Tm');
        expect(result[235]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[236]._operator).toEqual("'");
        expect(result[236]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the)']);
        expect(result[237]._operator).toEqual('Tm');
        expect(result[237]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[238]._operator).toEqual("'");
        expect(result[238]._operands).toEqual(['(wrong key in your application. To obtain the valid key, Click)']);
        expect(result[239]._operator).toEqual('ET');
        expect(result[239]._operands.length).toBe(0);
        expect(result[240]._operator).toEqual('BT');
        expect(result[240]._operands.length).toBe(0);
        expect(result[241]._operator).toEqual('rg');
        expect(result[241]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[242]._operator).toEqual('Tf');
        expect(result[242]._operands[1]).toEqual('14.000');
        expect(result[243]._operator).toEqual('Tm');
        expect(result[243]._operands).toEqual(['1.00', '.00', '.00', '1.00', '411.48', '-39.22']);
        expect(result[244]._operator).toEqual("'");
        expect(result[244]._operands).toEqual(['(here)']);
        expect(result[245]._operator).toEqual('ET');
        expect(result[245]._operands.length).toBe(0);
        expect(result[246]._operator).toEqual('q');
        expect(result[246]._operands.length).toBe(0);
        expect(result[247]._operator).toEqual('Q');
        expect(result[247]._operands.length).toBe(0);
        expect(result[248]._operator).toEqual('q');
        expect(result[248]._operands.length).toBe(0);
        expect(result[249]._operator).toEqual('cm');
        expect(result[249]._operands).toEqual(['1.00', '.00', '.00', '1.00', '257.50', '-381.00']);
        expect(result[250]._operator).toEqual('gs');
        expect(result[251]._operator).toEqual('cm');
        expect(result[251]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[252]._operator).toEqual('BT');
        expect(result[252]._operands.length).toBe(0);
        expect(result[253]._operator).toEqual('rg');
        expect(result[253]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[254]._operator).toEqual('Tf');
        expect(result[255]._operator).toEqual('Tm');
        expect(result[255]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[256]._operator).toEqual("'");
        expect(result[256]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[257]._operator).toEqual('Td');
        expect(result[257]._operands).toEqual(['0.000', '141.442']);
        expect(result[258]._operator).toEqual('ET');
        expect(result[258]._operands.length).toBe(0);
        expect(result[259]._operator).toEqual('Q');
        expect(result[259]._operands.length).toBe(0);
        parsed.destroy();
    });
    it('Merge Documents', () => {
        ...
        expect(result[3]._operator).toEqual('BT');
        ...
        expect(result[7]._operator).toEqual('Tf');
        expect(result[8]._operator).toEqual('Tr');
        expect(result[8]._operands).toEqual(['0']);
        expect(result[9]._operator).toEqual('Tc');
        expect(result[9]._operands).toEqual(['0.000']);
        expect(result[10]._operator).toEqual('Tw');
        expect(result[10]._operands).toEqual(['0.000']);
        expect(result[11]._operator).toEqual('Tz');
        expect(result[11]._operands).toEqual(['100.000']);
        expect(result[12]._operator).toEqual('Tm');
        expect(result[12]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[13]._operator).toEqual("'");
        expect(result[13]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in)']);
        expect(result[14]._operator).toEqual('Tm');
        expect(result[14]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[15]._operator).toEqual("'");
        expect(result[15]._operands).toEqual(['(your application. To obtain the valid key, Click)']);
        expect(result[16]._operator).toEqual('ET');
        ...
        expect(result[18]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[19]._operator).toEqual('Tf');
        expect(result[20]._operator).toEqual('Tm');
        expect(result[20]._operands).toEqual(['1.00', '.00', '.00', '1.00', '329.00', '-39.22']);
        expect(result[21]._operator).toEqual("'");
        expect(result[21]._operands).toEqual(['(here)']);
        ...
        expect(result[26]._operands).toEqual(['1.00', '.00', '.00', '1.00', '297.50', '-421.00']);
        expect(result[27]._operator).toEqual('gs');
        expect(result[28]._operator).toEqual('cm');
        expect(result[28]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[29]._operator).toEqual('BT');
        expect(result[29]._operands.length).toBe(0);
        expect(result[30]._operator).toEqual('rg');
        expect(result[30]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[31]._operator).toEqual('Tf');
        expect(result[32]._operator).toEqual('Tm');
        expect(result[32]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[33]._operator).toEqual("'");
        expect(result[33]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[34]._operator).toEqual('Td');
        expect(result[34]._operands).toEqual(['0.000', '141.442']);
    ...
    it('Rearrange pages', () => {
        ...
        expect(result[25]._operands.length).toBe(0);
        expect(result[26]._operator).toEqual('cm');
        expect(result[26]._operands).toEqual(['1.00', '.00', '.00', '1.00', '298.13', '-421.13']);
        expect(result[27]._operator).toEqual('gs');
        expect(result[28]._operator).toEqual('cm');
        expect(result[28]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[29]._operator).toEqual('BT');
    ...
    it('Watermark', () => {
        ...
        expect(result[27]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[28]._operator).toEqual("'");
        expect(result[28]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in)']);
        expect(result[29]._operator).toEqual('Tm');
        expect(result[29]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[30]._operator).toEqual("'");
        expect(result[30]._operands).toEqual(['(your application. To obtain the valid key, Click)']);
        ...
        expect(result[35]._operands).toEqual(['1.00', '.00', '.00', '1.00', '329.00', '-39.22']);
        expect(result[36]._operator).toEqual("'");
        expect(result[36]._operands).toEqual(['(here)']);
        ...
        expect(result[39]._operator).toEqual('Q');
        expect(result[39]._operands.length).toBe(0);
        expect(result[40]._operator).toEqual('q');
        expect(result[40]._operands.length).toBe(0);
        expect(result[41]._operator).toEqual('cm');
        expect(result[41]._operands).toEqual(['1.00', '.00', '.00', '1.00', '306.00', '-396.00']);
        expect(result[42]._operator).toEqual('gs');
        expect(result[43]._operator).toEqual('cm');
        expect(result[43]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[44]._operator).toEqual('BT');
        expect(result[44]._operands.length).toBe(0);
        expect(result[45]._operator).toEqual('rg');
        expect(result[45]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[46]._operator).toEqual('Tf');
        expect(result[47]._operator).toEqual('Tm');
        expect(result[47]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[48]._operator).toEqual("'");
        expect(result[48]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[49]._operator).toEqual('Td');
        expect(result[49]._operands).toEqual(['0.000', '141.442']);
        expect(result[50]._operator).toEqual('ET');
        expect(result[50]._operands.length).toBe(0);
        expect(result[51]._operator).toEqual('Q');
    ...
    it('Job application', () => {
        ...
        //Content level check
        expect(result[98]._operator).toEqual('BT');
        expect(result[98]._operands.length).toBe(0);
        expect(result[99]._operator).toEqual('rg');
        expect(result[99]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[100]._operator).toEqual('Tf');
        expect(result[101]._operator).toEqual('Tm');
        expect(result[101]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[102]._operator).toEqual("'");
        expect(result[102]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered)']);
        expect(result[103]._operator).toEqual('Tm');
        expect(result[103]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[104]._operator).toEqual("'");
        expect(result[104]._operands).toEqual(['(the wrong key in your application. To obtain the valid key, Click)']);
        expect(result[105]._operator).toEqual('ET');
        expect(result[105]._operands.length).toBe(0);
        expect(result[106]._operator).toEqual('BT');
        expect(result[106]._operands.length).toBe(0);
        expect(result[107]._operator).toEqual('rg');
        expect(result[107]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[108]._operator).toEqual('Tf');
        expect(result[109]._operator).toEqual('Tm');
        expect(result[109]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-55.40']);
        expect(result[110]._operator).toEqual("'");
        expect(result[110]._operands).toEqual(['(here)']);
        ...
        expect(result[113]._operator).toEqual('Q');
        expect(result[113]._operands.length).toBe(0);
        expect(result[114]._operator).toEqual('q');
        expect(result[114]._operands.length).toBe(0);
        expect(result[115]._operator).toEqual('cm');
        expect(result[115]._operands).toEqual(['1.00', '.00', '.00', '1.00', '250.00', '-155.00']);
        expect(result[116]._operator).toEqual('gs');
        expect(result[117]._operator).toEqual('cm');
        expect(result[117]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[118]._operator).toEqual('BT');
        expect(result[118]._operands.length).toBe(0);
        expect(result[119]._operator).toEqual('rg');
        expect(result[119]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[120]._operator).toEqual('Tf');
        expect(result[121]._operator).toEqual('Tm');
        expect(result[121]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[122]._operator).toEqual("'");
        expect(result[122]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
        expect(result[123]._operator).toEqual('Td');
        expect(result[123]._operands).toEqual(['0.000', '141.442']);
        expect(result[124]._operator).toEqual('ET');
        expect(result[124]._operands.length).toBe(0);
        expect(result[125]._operator).toEqual('Q');
        expect(result[125]._operands.length).toBe(0);
        parsed.destroy();
    });
    it('Bookmarks', () => {
        ...
        expect(result[69]._operands).toEqual(['1.000', '0.000', '0.000']);
        expect(result[70]._operator).toEqual('Tf');
        expect(result[71]._operator).toEqual('Tm');
        expect(result[71]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
        expect(result[72]._operator).toEqual("'");
        expect(result[72]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the)']);
        expect(result[73]._operator).toEqual('Tm');
        expect(result[73]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
        expect(result[74]._operator).toEqual("'");
        expect(result[74]._operands).toEqual(['(wrong key in your application. To obtain the valid key, Click)']);
        expect(result[75]._operator).toEqual('ET');
        expect(result[75]._operands.length).toBe(0);
        expect(result[76]._operator).toEqual('BT');
        expect(result[76]._operands.length).toBe(0);
        expect(result[77]._operator).toEqual('rg');
        expect(result[77]._operands).toEqual(['0.000', '0.000', '1.000']);
        expect(result[78]._operator).toEqual('Tf');
        expect(result[79]._operator).toEqual('Tm');
        expect(result[79]._operands).toEqual(['1.00', '.00', '.00', '1.00', '411.48', '-39.22']);
        expect(result[80]._operator).toEqual("'");
        expect(result[80]._operands).toEqual(['(here)']);
        expect(result[81]._operator).toEqual('ET');
    ...
    it('Form Filling -With Flatten', () => {
        ...
        expect(result[7]._operator).toEqual('Tf');
        expect(result[8]._operator).toEqual('Tr');
        expect(result[8]._operands).toBeDefined();
        expect(result[8]._operands).toEqual(['0']);
        expect(result[9]._operator).toEqual('Tc');
        expect(result[9]._operands).toEqual(['0.000']);
        expect(result[10]._operator).toEqual('Tw');
        ...
        expect(result[25]._operands.length).toBe(0);
        expect(result[26]._operator).toEqual('cm');
        expect(result[26]._operands).toEqual(['1.00', '.00', '.00', '1.00', '297.64', '-420.94']);
        expect(result[27]._operator).toEqual('gs');
        expect(result[28]._operator).toEqual('cm');
        expect(result[28]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
        expect(result[29]._operator).toEqual('BT');
    ...
    it('1003529 - rotate 90 register - without license', () => {
        ...
        expect(result[9]._operator).toEqual('cm');
        expect(result[9]._operands).toEqual(['.00', '1.00', '-1.00', '.00', '.00', '.00']);
        expect(result[10]._operator).toEqual('BT');
        ...
        expect(result[19]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-722.00', '-23.03']);
        expect(result[20]._operator).toEqual("'");
        expect(result[20]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in your application. To)']);
        expect(result[21]._operator).toEqual('Tm');
        expect(result[21]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-722.00', '-39.22']);
        expect(result[22]._operator).toEqual("'");
        expect(result[22]._operands).toEqual(['(obtain the valid key, Click)']);
        ...
        expect(result[26]._operator).toEqual('Tf');
        expect(result[27]._operator).toEqual('Tm');
        expect(result[27]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-559.05', '-39.22']);
        expect(result[28]._operator).toEqual("'");
        expect(result[28]._operands).toEqual(['(here)']);
        ...
        expect(result[33]._operands).toEqual(['1.00', '.00', '.00', '1.00', '257.50', '-381.00']);
        expect(result[34]._operator).toEqual('gs');
        expect(result[35]._operator).toEqual('cm');
        expect(result[35]._operands).toEqual(['-0.71', '0.71', '-0.71', '-0.71', '.00', '.00']);
        ...
        expect(result[39]._operator).toEqual('Tr');
        expect(result[39]._operands).toEqual(['0']);
        expect(result[40]._operator).toEqual('Tc');
        expect(result[40]._operands).toEqual(['0.000']);
        expect(result[41]._operator).toEqual('Tw');
        expect(result[41]._operands).toEqual(['0.000']);
        expect(result[42]._operator).toEqual('Tz');
        expect(result[42]._operands).toEqual(['100.000']);
        expect(result[43]._operator).toEqual('Tm');
        expect(result[43]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
        expect(result[44]._operator).toEqual("'");
        expect(result[44]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
    ...
    it('1003529 - rotate 270 register - without license', () => {
        ...
        expect(result[8]._operands.length).toBe(0);
        expect(result[9]._operator).toEqual('cm');
        expect(result[9]._operands).toEqual(['-0.00', '-1.00', '1.00', '-0.00', '.00', '.00']);
        expect(result[10]._operator).toEqual('BT');
        expect(result[10]._operands.length).toBe(0);
        expect(result[11]._operator).toEqual('CS');
        expect(result[11]._operands).toEqual(['/DeviceRGB']);
        ...
        expect(result[18]._operands).toEqual(['100.000']);
        expect(result[19]._operator).toEqual('Tm');
        expect(result[19]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '491.97']);
        expect(result[20]._operator).toEqual("'");
        expect(result[20]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in your application. To)']);
        expect(result[21]._operator).toEqual('Tm');
        expect(result[21]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '475.78']);
        expect(result[22]._operator).toEqual("'");
        expect(result[22]._operands).toEqual(['(obtain the valid key, Click)']);
        expect(result[23]._operator).toEqual('ET');
        expect(result[23]._operands.length).toBe(0);
        ...
        expect(result[26]._operator).toEqual('Tf');
        expect(result[27]._operator).toEqual('Tm');
        expect(result[27]._operands).toEqual(['1.00', '.00', '.00', '1.00', '202.95', '475.78']);
        expect(result[28]._operator).toEqual("'");
        expect(result[28]._operands).toEqual(['(here)']);
        expect(result[29]._operator).toEqual('ET');
        expect(result[29]._operands.length).toBe(0);
        ...
        it(tc.title, () => {
            ...
            switch (tc.title) {
                case 'Portrait (default margins)': {
                    ...
                    expect(result[32]._operands).toEqual(['1.000', '0.000', '0.000']);
                    expect(result[33]._operator).toEqual('Tf');
                    expect(result[34]._operator).toEqual('Tm');
                    expect(result[34]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
                    expect(result[35]._operator).toEqual("'");
                    expect(result[35]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the)']);
                    expect(result[36]._operator).toEqual('Tm');
                    expect(result[36]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
                    expect(result[37]._operator).toEqual("'");
                    expect(result[37]._operands).toEqual(['(wrong key in your application. To obtain the valid key, Click)']);
                    expect(result[38]._operator).toEqual('ET');
                    expect(result[38]._operands.length).toBe(0);
                    expect(result[39]._operator).toEqual('BT');
                    expect(result[39]._operands.length).toBe(0);
                    expect(result[40]._operator).toEqual('rg');
                    expect(result[40]._operands).toEqual(['0.000', '0.000', '1.000']);
                    expect(result[41]._operator).toEqual('Tf');
                    expect(result[42]._operator).toEqual('Tm');
                    expect(result[42]._operands).toEqual(['1.00', '.00', '.00', '1.00', '411.48', '-39.22']);
                    expect(result[43]._operator).toEqual("'");
                    expect(result[43]._operands).toEqual(['(here)']);
                    expect(result[44]._operator).toEqual('ET');
                    expect(result[45]._operator).toEqual('q');
                    expect(result[45]._operator).toEqual('q');
                    expect(result[46]._operands.length).toBe(0);
                    expect(result[48]._operator).toEqual('cm');
                    expect(result[48]._operands).toEqual(['1.00', '.00', '.00', '1.00', '266.00', '-356.00']);
                ...
                case 'Landscape (no margin)': {
                    ...
                    expect(result[32]._operands).toEqual(['1.000', '0.000', '0.000']);
                    expect(result[33]._operator).toEqual('Tf');
                    expect(result[33]._operands[1]).toEqual('14.000');
                    expect(result[34]._operator).toEqual('Tm');
                    expect(result[34]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
                    expect(result[35]._operator).toEqual("'");
                    expect(result[35]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in your application. To obtain the)']);
                    expect(result[36]._operator).toEqual('Tm');
                    expect(result[36]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
                    expect(result[37]._operator).toEqual("'");
                    expect(result[37]._operands).toEqual(['(valid key, Click)']);
                    expect(result[38]._operator).toEqual('ET');
                    expect(result[38]._operands.length).toBe(0);
                    expect(result[39]._operator).toEqual('BT');
                    expect(result[39]._operands.length).toBe(0);
                    ...
                    expect(result[41]._operator).toEqual('Tf');
                    expect(result[42]._operator).toEqual('Tm');
                    expect(result[42]._operands).toEqual(['1.00', '.00', '.00', '1.00', '137.57', '-39.22']);
                    expect(result[43]._operator).toEqual("'");
                    expect(result[43]._operands).toEqual(['(here)']);
                    expect(result[44]._operator).toEqual('ET');
                    expect(result[44]._operands.length).toBe(0);
                    ...
                    expect(result[47]._operands.length).toBe(0);
                    expect(result[48]._operator).toEqual('cm');
                    expect(result[48]._operands).toEqual(['1.00', '.00', '.00', '1.00', '396.00', '-306.00']);
                    expect(result[49]._operator).toEqual('gs');
                    expect(result[50]._operator).toEqual('cm');
                    expect(result[50]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
                    expect(result[51]._operator).toEqual('BT');
                ...
                case 'Small-margin 20': {
                    ...
                    expect(result[34]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
                    expect(result[35]._operator).toEqual("'");
                    expect(result[35]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key)']);
                    expect(result[36]._operator).toEqual('Tm');
                    expect(result[36]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
                    expect(result[37]._operator).toEqual("'");
                    expect(result[37]._operands).toEqual(['(in your application. To obtain the valid key, Click)']);
                    expect(result[38]._operator).toEqual('ET');
                    expect(result[38]._operands.length).toBe(0);
                    expect(result[39]._operator).toEqual('BT');
                    expect(result[39]._operands.length).toBe(0);
                    ...
                    expect(result[41]._operator).toEqual('Tf');
                    expect(result[42]._operator).toEqual('Tm');
                    expect(result[42]._operands).toEqual(['1.00', '.00', '.00', '1.00', '343.79', '-39.22']);
                    expect(result[43]._operator).toEqual("'");
                    expect(result[43]._operands).toEqual(['(here)']);
                    expect(result[44]._operator).toEqual('ET');
                    expect(result[44]._operands.length).toBe(0);
                    ...
                    expect(result[47]._operands.length).toBe(0);
                    expect(result[48]._operator).toEqual('cm');
                    expect(result[48]._operands).toEqual(['1.00', '.00', '.00', '1.00', '286.00', '-376.00']);
                    expect(result[49]._operator).toEqual('gs');
                    expect(result[50]._operator).toEqual('cm');
                    expect(result[50]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
                    expect(result[51]._operator).toEqual('BT');
                ...
                case 'A4 Portrait (default margins)': {
                    ...
                    expect(result[47]._operands.length).toBe(0);
                    expect(result[48]._operator).toEqual('cm');
                    expect(result[48]._operands).toEqual(['1.00', '.00', '.00', '1.00', '257.50', '-381.00']);
                    expect(result[49]._operator).toEqual('gs');
                    expect(result[50]._operator).toEqual('cm');
                    expect(result[50]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
                    expect(result[51]._operator).toEqual('BT');
                ...
                case 'A4 Landscape (margin 30)': {
                    ...
                    expect(result[47]._operands.length).toBe(0);
                    expect(result[48]._operator).toEqual('cm');
                    expect(result[48]._operands).toEqual(['1.00', '.00', '.00', '1.00', '391.00', '-267.50']);
                    expect(result[49]._operator).toEqual('gs');
                    expect(result[50]._operator).toEqual('cm');
                    expect(result[50]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
                    expect(result[51]._operator).toEqual('BT');
                ...
                case 'A5 Portrait (no margin)': {
                    ...
                    expect(result[34]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
                    expect(result[35]._operator).toEqual("'");
                    expect(result[35]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or)']);
                    expect(result[36]._operator).toEqual('Tm');
                    expect(result[36]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
                    expect(result[37]._operator).toEqual("'");
                    expect(result[37]._operands).toEqual(['(registered the wrong key in your application. To obtain)']);
                    expect(result[38]._operator).toEqual('Tm');
                    expect(result[38]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-55.40']);
                    expect(result[39]._operator).toEqual("'");
                    expect(result[39]._operands).toEqual(['(the valid key, Click)']);
                    ...
                    expect(result[44]._operands).toEqual(['1.00', '.00', '.00', '1.00', '160.92', '-55.40']);
                    expect(result[45]._operator).toEqual("'");
                    expect(result[45]._operands).toEqual(['(here)']);
                    expect(result[46]._operator).toEqual('ET');
                    expect(result[46]._operands.length).toBe(0);
                    expect(result[47]._operator).toEqual('q');
                    expect(result[47]._operands.length).toBe(0);
                    ...
                    expect(result[50]._operator).toEqual('cm');
                    expect(result[50]._operands).toEqual(['1.00', '.00', '.00', '1.00', '210.00', '-297.50']);
                    expect(result[51]._operator).toEqual('gs');
                    expect(result[52]._operator).toEqual('cm');
                    expect(result[52]._operands).toEqual(['0.71', '0.71', '-0.71', '0.71', '.00', '.00']);
                    expect(result[53]._operator).toEqual('BT');
                    expect(result[53]._operands.length).toBe(0);
                    expect(result[54]._operator).toEqual('rg');
                    expect(result[54]._operands).toEqual(['1.000', '0.000', '0.000']);
                    expect(result[55]._operator).toEqual('Tf');
                    expect(result[56]._operator).toEqual('Tm');
                    expect(result[56]._operands).toEqual(['1.00', '.00', '.00', '1.00', '-165.72', '-4.94']);
                    expect(result[57]._operator).toEqual("'");
                    expect(result[57]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library.)']);
                    expect(result[58]._operator).toEqual('Td');
                    expect(result[58]._operands).toEqual(['0.000', '141.442']);
                    expect(result[59]._operator).toEqual('ET');
                    expect(result[59]._operands.length).toBe(0);
                    expect(result[60]._operator).toEqual('Q');
                ...
                case 'Legal Landscape (default margins)': {
                    ...
                    expect(result[34]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-23.03']);
                    expect(result[35]._operator).toEqual("'");
                    expect(result[35]._operands).toEqual(['(Created with a trial version of Syncfusion PDF library or registered the wrong key in your application. To obtain the valid key, Click)']);
                    ...
                    expect(result[40]._operands).toEqual(['1.00', '.00', '.00', '1.00', '40.00', '-39.22']);
                    expect(result[41]._operator).toEqual("'");
                    expect(result[41]._operands).toEqual(['(here)']);
                    ...
                    expect(result[46]._operands).toEqual(['1.00', '.00', '.00', '1.00', '464.00', '-266.00']);
