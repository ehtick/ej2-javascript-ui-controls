...
describe('PdfDocument Creation Annotation Test', () => {
    ...
    it('955129 - Free text annotation Apperance issue', () => {
        ...
        expect(result[19]._operands).toEqual(['1.00', '.00', '.00', '1.00', '94.00', '691.48']);
        expect(result[20]._operator).toEqual("'");
        expect(result[20]._operands).toEqual(['(Free Text)']);
    ...
    it('Annotation Creation stream - set Appearance', () => {
        ...
        expect(result[18]._operands).toEqual(['100.000']);
        expect(result[19]._operator).toEqual('Tm');
        expect(result[19]._operands).toEqual(['1.00', '.00', '.00', '1.00', '162.00', '493.48']);
        expect(result[20]._operator).toEqual("'");
        expect(result[20]._operands).toEqual(['(FreeText Annotation1)']);
        expect(result[21]._operator).toEqual('ET');
        expect(result[21]._operands).toEqual([]);
        expect(loadedAnnot.name).toEqual('FreeText Annotation');
        expect(loadedAnnot.text).toEqual('FreeText Annotation1');
