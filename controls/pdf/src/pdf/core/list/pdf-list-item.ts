...
export class PdfListItem {
    /**
     * Brush used to render the list item text.
     *
     * @private
     * @type {PdfBrush}
     */
    _brush: PdfBrush;
    /**
     * Pen used to stroke the list item text.
     *
     * @private
     * @type {PdfPen}
     */
    _pen: PdfPen;
    /**
     * Font used for the list item text.
     *
     * @private
     * @type {PdfFont}
     */
    _font: PdfFont;
    /**
     * String format used when laying out the list item text.
     *
     * @private
    ...
    /**
     * The raw text content for the list item.
     *
     * @private
     * @type {string}
     */
    _text: string;
    /**
     * Text indent for this list item.
     *
     * @private
     * @type {number}
     */
    ...
    /**
     * Optional nested sub-list for this item.
     *
     * @private
     * @type {PdfList}
     */
...
export class PdfListItemCollection {
    /**
     * Internal array storing list items.
     *
     * @private
     * @type {PdfListItem[]}
     */
    ...
    /**
     * Cached count of items (usage internal).
     *
     * @private
     * @type {number}
     */
