...
export class PdfPageImportOptions {
    /**
     * Specifies the target page index at which the imported page will be inserted.
     *
     * @private
     */
    _targetIndex: number;
    /**
     * Defines the rotation angle to be applied to the imported page.
     *
     * @private
     */
    _rotation: PdfRotationAngle;
    /**
     * Indicates whether the resources of the imported page should be optimized to avoid duplication.
     *
     * @private
     */
    _optimizeResources: boolean = true;
    /**
     * Determines whether form fields from the imported page must be grouped to avoid name conflicts.
     *
     * @private
     */
