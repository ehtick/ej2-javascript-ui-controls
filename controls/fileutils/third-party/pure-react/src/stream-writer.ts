...
export class StreamWriter {
    ...
    private setBomByte(): void {
        if (this.encoding.includeBom) {
            ...
            case 'Unicode': {
                const arrayUnicode: ArrayBuffer = new ArrayBuffer(2);
                const uint8: Uint8Array = new Uint8Array(arrayUnicode);
                uint8[0] = 255;
                uint8[1] = 254;
            ...
            case 'Utf8': {
                const arrayUtf8: ArrayBuffer = new ArrayBuffer(3);
                const utf8: Uint8Array = new Uint8Array(arrayUtf8);
                utf8[0] = 239;
                utf8[1] = 187;
                utf8[2] = 191;
    ...
    private flush(): void {
        ...
        const bufferArray: ArrayBuffer = this.encoding.getBytes(this.bufferText, 0, this.bufferText.length);
        this.bufferText = '';
