...
@include export-module('chatui-layout') {
  .e-chat-ui {
    ...
    .e-message-wrapper .e-chat-message-toolbar {
      position: absolute;
    }
    .e-message-wrapper > .e-chat-message-toolbar {
      position: fixed;
    ...
    .e-footer {
      ...
      &.e-footer-focus-wave-effect {
        @if ($skin-name == 'Material3' or $skin-name == 'fluent2' or $skin-name == 'material' or $skin-name == 'material-dark') {
          ...
          &.e-upload-drag-hover::before {
            width: 50%;
          }
          &.e-footer-focused::after,
          &.e-upload-drag-hover::after {
            width: 50%;
          }
        }
      }
    ...
    .e-pinned-message {
      ...
      .e-pinned-message-text{
        ...
        .e-chat-file-icon-svg svg {
          width: $pin-file-icon-size;
          height: $pin-file-icon-size;
        }
      }
    }
    .e-reply-wrapper {
      .e-reply-media-preview {
        ...
        .e-chat-file-icon-svg svg {
          width: $reply-file-icon-size;
          height: $reply-file-icon-size;
        }
      }
    }
    .e-preview-overlay {
