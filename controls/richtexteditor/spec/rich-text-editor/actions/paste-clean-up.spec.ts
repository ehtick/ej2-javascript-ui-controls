...
import { DialogModel, Popup } from '@syncfusion/ej2-popups';
...
describe("paste cleanup testing", () => {
  ...
  it("Paste by Keep Formatting when Denied Tags with only allowed attributes are set", (done) => {
    ...
    setTimeout(() => {
      ...
      let allElem: any = (rteObj as any).inputElement.firstElementChild.firstElementChild.querySelectorAll("*");
      let expected: boolean = true;
      for (let i: number = 0; i < allElem.length; i++) {
        for (let j: number = 0; j < rteObj.pasteCleanupSettings.deniedTags.length; j++) {
          if (allElem[i].tagName.toLowerCase() === rteObj.pasteCleanupSettings.deniedTags[j]) {
...
third line`;
  ...
  it("Paste base64 images testing 1", (done) => {
...
+ `" alt="Image result for base64 image" style="background-color: unset; text-align: inherit; font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, sans-serif, -apple-system, BlinkMacSystemFont; outline: rgb(74, 144, 226) solid 2px;" class="e-resize e-img-focus" width="39" height="52">
    ...
    let file: any = (pasteCleanupObj as any).pasteObj.base64ToFile(base64, fileName);
    setTimeout(() => {
...
describe("To test action Complete event for the image and content", () => {
  ...
  it("Paste base64 images testing 2", (done) => {
    let localElem: string = `<div style="color:red;" id="content-edit" contenteditable="true" class="e-node-deletable e-node-inner">
    <img src="data:image/png;base64,`
+ `" alt="Image result for base64 image" style="background-color: unset; text-align: inherit; font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, sans-serif, -apple-system, BlinkMacSystemFont; outline: rgb(74, 144, 226) solid 2px;" class="e-resize e-img-focus" width="39" height="52">
    </div>`;
...
describe("EJ2-46613 - Pasting content with bolded list doesn't paste the content", () => {
  ...
  describe("Paste Cleanup events testing", () => {
    ...
    it("Paste base64 images testing 3", (done) => {
...
describe('962589: li Element with Empty Inline Style Attribute (style=\"\") Is Added When Pasting List in the RichTextEditor', () => {
    ...
    beforeEach((done: DoneFn) => {
        editor = renderRTE({
            ...
            value: `<ul><li>Basic features include headings, block quotes, numbered lists, bullet lists, and support to insert images, tables, audio, and video.</li></ul>`
        });
        done();
    });
    ...
    it('should paste a list item without empty styles tag', (done: DoneFn) => {
        const liElement: HTMLElement = editor.inputElement.querySelector('li');
        setCursorPoint(liElement.childNodes[0], liElement.textContent.length);

        const clipBoardData: string = '\x3C!--StartFragment--><ul style="color: rgb(51, 51, 51); font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, &quot;sans-serif&quot;, -apple-system, BlinkMacSystemFont; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; background-color: rgb(255, 255, 255);" class="pasteContent_RTE"><li style="margin-bottom: 10px;">Basic features include headings, block quotes, numbered lists, bullet lists, and support to insert images, tables, audio, and video.</li></ul>\x3C!--EndFragment-->';
        ...
        setTimeout(() => {
            const pastedLiElement: HTMLLIElement = editor.inputElement.querySelectorAll('li')[1];
            expect(pastedLiElement.hasAttribute('style')).toBe(false);
            done();
        }, 100);
    });
});
...
describe("BLAZ-20276 - Pasting content after shift+Enter throws console error issue - ", () => {
    ...
    it(" pasting content after shift + enter content issue - ", (done) => {
        ...
        setTimeout(() => {
          ...
          expect((rteObj as any).inputElement.innerHTML === `<p class="focusElement">RTE Content</p><div><b style="font-weight: 500; color: rgba(0, 0, 0, 0.87); font-family: Heebo, &quot;segoe ui&quot;; font-size: 14px; font-style: normal; text-align: start; text-indent: 0px; white-space: normal; background-color: rgb(255, 255, 255);">Actual Behavior</b><span style="color: rgba(0, 0, 0, 0.87); font-family: Heebo, &quot;segoe ui&quot;; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; white-space: normal; background-color: rgb(255, 255, 255); float: none; display: inline !important;">: &nbsp;Need to paste the content after shift+enter without any console error.</span></div>`).toBe(true)
          done();
        }, 50);
    });
...
describe("EJ2-58258 - Pasting content after shift+Enter doesn't paste the content - ", () => {
    ...
    it(" pasting content after shift + enter doesn't paste - ", (done) => {
        ...
        setTimeout(() => {
          ...
          const expectedElem: string = '<p class="focusElement">RTE Content<br><span style="color: rgb(51, 51, 51); font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, &quot;sans-serif&quot;, -apple-system, BlinkMacSystemFont; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; background-color: rgb(255, 255, 255); float: none; display: inline !important;">RTE Content</span><br></p>';
...
describe("EJ2-69216 - pasting as plain text when BR is configured", () => {
    ...
    it("Pasting content when enterKey is configured as BR and Div not working issue test case", (done) => {
      ...
      setTimeout(() => {
        ...
        expect((rteObj as any).inputElement.innerHTML === 'This is a test<br><br> Paste below:<br><br><p><b><span lang="CA">This is a test</span></b></p><p><i><u><span lang="CA">This is a test</span></u></i></p><br><span><br></span><br>').toBe(true)
        done();
      }, 100);
    });
    afterAll((done: DoneFn) => {
...
describe('850189 - Border lines are appeared on the images while copy paste the image', () => {
    ...
    it ('Should remvoe the outline style for the pasted image.', (done: DoneFn) => {
        editor.focusIn();
        const clipBoardData: string = '\n\n\x3C!--StartFragment--><img alt="Logo" src="https://ej2.syncfusion.com/demos/src/rich-text-editor/images/RTEImage-Feather.png" class="e-rte-image e-img-inline e-resize e-img-focus" style="box-sizing: border-box; border: 0px; vertical-align: bottom; cursor: pointer; display: inline-block; float: none; margin: auto; max-width: 1489px; position: relative; padding: 1px; z-index: 1000; color: rgb(51, 51, 51); font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, &quot;sans-serif&quot;, -apple-system, BlinkMacSystemFont; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; width: 300px; outline: rgb(74, 144, 226) solid 2px;">\x3C!--EndFragment-->\n\n';
        const dataTransfer: DataTransfer = new DataTransfer();
        dataTransfer.setData('text/html', clipBoardData);
        const pasteEvent: ClipboardEvent = new ClipboardEvent('paste', { clipboardData: dataTransfer } as ClipboardEventInit);
        editor.onPaste(pasteEvent);
...
describe('850189 - code coverage', () => {
    ...
    it ('code coverage.', (done: DoneFn) => {
        ...
        (editor as any).pasteCleanupModule.bindOnEnd();
        ...
        expect((editor as any).pasteCleanupModule.pasteObj.addTableClass(div, null) === div).toBe(true);
        div = document.createElement('div');
        div.innerHTML = `<img alt="Sky with sun" src="https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Overview.png" class="e-rte-image e-img-inline e-img-cropped" style=" border: 0px; vertical-align: bottom; cursor: pointer; display: inline-block; float: none; margin: auto 5px; max-width: 100%; position: relative; padding: 1px; color: rgb(36, 36, 36); font-family: &quot;Segoe UI&quot;, -apple-system, blinkMacSystemfont, Roboto, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-weight: 400; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; background-color: rgb(250, 250, 250); width: 440px;" />`;
        (editor as any).pasteCleanupModule.pasteObj.convertBlobToBase64(div);
        expect(div.querySelector('img').src === 'https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Overview.png').toBe(true);
        (editor as any).pasteCleanupModule.pasteObj.cropImageHandler(div);
        ...
        (editor as any).pasteCleanupModule.pasteObj.processPictureElement(div);
    ...
    it('Coverage for branches in getBlob method in processImagesWithSaveUrl method', (done: Function) => {
        const pasteCleanup = editor.pasteCleanupModule;
        (pasteCleanup as any).addEventListener();
        (pasteCleanup as any).bindOnEnd();

        const mockBase64Image = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUA';
        const imgElement = document.createElement('img');
        imgElement.src = mockBase64Image;
       // Create an array of images and append them to a DocumentFragment
        const imageArray: HTMLImageElement[] = [imgElement];
        const fragment = document.createDocumentFragment();
        imageArray.forEach(img => fragment.appendChild(img)); // Append images to the fragment
        // Use querySelectorAll on the fragment to retrieve a NodeListOf<HTMLImageElement>
        const allImgElm: NodeListOf<HTMLImageElement> = fragment.querySelectorAll('img');
        (pasteCleanup as any).parent.insertImageSettings.path = null;
        (pasteCleanup as any).parent.dataBind();
        (pasteCleanup as any).processImagesWithSaveUrl(allImgElm);
        //(pasteCleanup as any).removeEventListener();

        const tempDiv = document.createElement('div');
        (pasteCleanup as any).parent.editorMode = 'Markdown';
        (pasteCleanup as any).bindOnEnd();
        (pasteCleanup as any).parent.editorMode = 'HTML';
        (pasteCleanup as any).contentModule = null;
        (pasteCleanup as any).bindOnEnd();

        (editor as any).pasteCleanupModule.pasteObj.processPictureElement(tempDiv);
        (editor as any).pasteCleanupModule.pasteObj.removeTempClass();
        (pasteCleanup as any).parent.insertImageSettings.saveUrl = null;
        (pasteCleanup as any).parent.insertImageSettings.saveFormat = 'Base64';
        (pasteCleanup as any).imgUploading(tempDiv);

        //Setting opacity 0.5 image element with src case
        let imageElm = document.createElement('img');
        imageElm.setAttribute('id', 'hello');
        imageElm.style.opacity = '0.5';
        (pasteCleanup as any).parent.inputElement.appendChild(imgElement);
        (pasteCleanup as any).updateImageSource(imageElm, 'testingSrc', 'testingAlt');
        (pasteCleanup as any).updateDetachedImages([imageElm], 'testingSrc', 'testingAlt');
        imageElm.style.opacity = '1';
        (pasteCleanup as any).updateDetachedImages([imageElm], 'testingSrc', 'testingAlt');

        //handleUploading method else part
        (pasteCleanup as any).parent.isServerRendered = true;
        (pasteCleanup as any).handleUploading(editor, imageElm);
        (pasteCleanup as any).parent.isServerRendered = false;
        (pasteCleanup as any).removeEventListener();

        let popupObj: Popup;
        popupObj = new Popup(editor.element, {
            height: '85px',
            width: '300px',
        });
        const currentCss = (pasteCleanup as any).parent.cssClass;
        (pasteCleanup as any).parent.cssClass = 'testing';
        (pasteCleanup as any).popupObj = popupObj;
        (pasteCleanup as any).configurePopupStyles(allImgElm);
        expect(imgElement.nodeName === 'IMG').toBe(true); // Dummy except.
        (pasteCleanup as any).parent.cssClass = currentCss;

        (pasteCleanup as any).popupObj = popupObj;
        (pasteCleanup as any).hideFileSelectWrapper();

        const imgElm = document.createElement('img');
        imgElm.src = mockBase64Image;
        (pasteCleanup as any).positionPopupAtImage((pasteCleanup as any).popupObj, imgElm);
        done();
    });

    it('should clear fireFoxUploadTime and failureTime timers in destroy method', () => {
        const pasteCleanup = (editor as any).pasteCleanupModule;
        // Mocking setTimeout and assigning it to fireFoxUploadTime and failureTime
        pasteCleanup.fireFoxUploadTime = setTimeout(() => {}, 10);
        pasteCleanup.failureTime = setTimeout(() => {}, 10);
        spyOn(window, 'clearTimeout').and.callThrough();
        pasteCleanup.destroy();
        expect(pasteCleanup.fireFoxUploadTime).toBeNull();
        expect(pasteCleanup.failureTime).toBeNull();
        (editor as any).pasteCleanupModule.parent = null;
    });
})
    ...
    describe('854594: Difference in Alignment and line height in paste cleanup.', () => {
        ...
        it ('Should remove the Margin left for the msolistparagraph class ul ol and subract 0.5 in for the Nested List.', (done: DoneFn) => {
            ...
            setTimeout(() => {
                ...
                // Whole Inner HTML
                const expectedElem: string = '<p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in 0in 7.5pt; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">The Rich Text Editor is a WYSIWYG ("what you see is what you get") editor useful to create and edit content and return the valid&nbsp;</span><span style="color: black;"><a href="https://ej2.syncfusion.com/home/" target="_blank" aria-label="Open in new window"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(46, 46, 241);">HTML markup</span></a></span><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;or&nbsp;</span><span style="color: black;"><a href="https://ej2.syncfusion.com/home/" target="_blank" aria-label="Open in new window"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(46, 46, 241);">markdown</span></a></span><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;of the content</span></p><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in 0in 7.5pt; background: white;"><b><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Toolbar</span></b></p><ol level="1" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin: 0in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">The Toolbar contains commands to align the text, insert a link, insert an image, insert list, undo/redo operations, HTML view, etc</span></p></li><li style="margin: 0in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">The Toolbar is fully customizable</span></p></li></ol><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in 0in 7.5pt; background: white;"><b><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Links</span></b></p><ol level="1" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin: 0in 0in 0in 1.25in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">You can insert a hyperlink with its corresponding dialog</span></p></li><li style="margin: 0in 0in 0in 1.25in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Attach a hyperlink to the displayed text.</span></p></li><li style="margin: 0in 0in 0in 1.25in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Customize the quick toolbar based on the hyperlink</span></p></li></ol><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in 0in 7.5pt; background: white;"><b><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Image.</span></b></p><ol level="1" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin: 0in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Allows you to insert images from an online source as well as the local computer</span></p></li><li style="margin: 0in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">You can upload an image</span></p></li><li style="margin: 0in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Provides an option to customize the quick toolbar for an image</span></p></li></ol><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;</span></p><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;</span></p><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;</span></p><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;</span></p><p style="font-size: 12pt; font-family: &quot;Times New Roman&quot;, serif; margin: 0in; background: white;"><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">&nbsp;</span></p><ul level="1" style="margin-bottom: 0in; list-style-type: disc;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 0in; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Rich Text Editor.</p></li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Mark down Editor.</p></li></ul><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><ul style="margin-bottom: 0in; list-style-type: none;"><li style="list-style-type: none;"><ul level="2" style="margin-bottom: 0in; list-style-type: circle;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 0in; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Rich Text Editor.</p></li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Mark down Editor.</p></li></ul></li></ul><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">FASDFADSADFS</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">ASDFASDA</p><ul style="margin-bottom: 0in; list-style-type: none;"><li style="list-style-type: none;"><ul style="margin-bottom: 0in; list-style-type: none;"><li style="list-style-type: none;"><ul level="3" style="margin-bottom: 0in; list-style-type: square;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 0in; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Rich Text Editor.</p></li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>The Mark down Editor.</p></li></ul></li></ul></li></ul><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><ol level="1" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin: 0in 0in 0in 2in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">You can insert a hyperlink with its corresponding dialog</span></p></li><li style="margin: 0in 0in 0in 2in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Attach a hyperlink to the displayed text.</span></p></li><li style="margin: 0in 0in 0in 2in; background: white;"><p><span style="font-size: 10.5pt; font-family: Roboto; color: rgb(51, 51, 51);">Customize the quick toolbar based on the hyperlink</span></p></li></ol><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">&nbsp;</p><ol level="1" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 0in; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>List 1</p></li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>List 2</p></li></ol><p style="margin: 0in 0in 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;">This is not a list</p><ol level="1" start="3" style="margin-bottom: 0in; list-style-type: decimal;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;"><p>List 3</p></li></ol>';
...
describe('Bug 912791: Table Pasting Outside Editable Area Results in Empty Setter Value', () => {
    ...
    it(' To verify that table pasting functions correctly after deleting a table and pasting a same table in the same location.', (done: DoneFn) => {
        ...
        setTimeout(function () {
            ...
            (tablePop.querySelectorAll(".e-rte-quick-toolbar .e-toolbar-items .e-toolbar-item .e-tbar-btn")[1] as HTMLElement).click();
...
StarSymbol"><span style="mso-list:Ignore"><span style="font:7.0pt &quot;Times New Roman&quot;">      <span class="Apple-converted-space"> </span></span>•<span style="font:7.0pt &quot;Times New Roman&quot;">        <span class="Apple-converted-space"> </span></span></span></span><!--[endif]-->Maybe an existing group implementation can be reused for this.<o:p></o:p></p><h1 style="margin: 12pt 0in 6pt; break-after: avoid; font-size: 14pt; font-family: Arial, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration: none;"><a name="part-2---create-and-assign-ticket-to-a-g">Part 2 - Create and assign ticket to a group</a><o:p></o:p></h1><p class="Firstparagraph" style="margin: 4.3pt 0in; font-size: medium; font-family: &quot;Times New Roman&quot;, serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration: none;"><img width="499" height="214" src="blob:null/9c4dab55-038a-47b5-8be4-90c44e391017" align="left" hspace="12" v:shapes="img1"><o:p></o:p></p><p class="Textbody" style="margin: 4.3pt 0in; font-size: medium; font-family: &quot;Times New Roman&quot;, serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; text-decoration: none;"><o:p> </o:p></p></html>`;
        ...
        it ('Should remove the ul wrapping the paragraph nodes.', (done: DoneFn) => {
            editor.focusIn();
    ...
    describe("919705 - Prevent pasting images other than the allowed types is being mentioned - ", () => {
        let rteObj: RichTextEditor;
        let editorObj: EditorManager;
        let keyBoardEvent: any = {
            preventDefault: () => { },
        ...
        it("Prevent pasting images from word other than the allowed types - ", (done) => {
            let localElem: string = `<html xmlns:v="urn:schemas-microsoft-com:vml"\r\nxmlns:o="urn:schemas-microsoft-com:office:office"\r\nxmlns:w="urn:schemas-microsoft-com:office:word"\r\nxmlns:m="http://schemas.microsoft.com/office/2004/12/omml"\r\nxmlns="http://www.w3.org/TR/REC-html40">\r\n\r\n<head>\r\n<meta http-equiv=Content-Type content="text/html; charset=utf-8">\r\n<meta name=ProgId content=Word.Document>\r\n<meta name=Generator content="Microsoft Word 15">\r\n<meta name=Originator content="Microsoft Word 15">\r\n<link rel=File-List\r\nhref="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_filelist.xml">\r\n<link rel=Edit-Time-Data\r\nhref="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_editdata.mso">\r\n\x3C!--[if !mso]>\r\n<style>\r\nv\\:* {behavior:url(#default#VML);}\r\no\\:* {behavior:url(#default#VML);}\r\nw\\:* {behavior:url(#default#VML);}\r\n.shape {behavior:url(#default#VML);}\r\n</style>\r\n<![endif]-->\x3C!--[if gte mso 9]><xml>\r\n <o:OfficeDocumentSettings>\r\n  <o:AllowPNG/>\r\n </o:OfficeDocumentSettings>\r\n</xml><![endif]-->\r\n<link rel=themeData\r\nhref="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_themedata.thmx">\r\n<link rel=colorSchemeMapping\r\nhref="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_colorschememapping.xml">\r\n\x3C!--[if gte mso 9]><xml>\r\n <w:WordDocument>\r\n  <w:View>Normal</w:View>\r\n  <w:Zoom>0</w:Zoom>\r\n  <w:TrackMoves>false</w:TrackMoves>\r\n  <w:TrackFormatting/>\r\n  <w:PunctuationKerning/>\r\n  <w:ValidateAgainstSchemas/>\r\n  <w:SaveIfXMLInvalid>false</w:SaveIfXMLInvalid>\r\n  <w:IgnoreMixedContent>false</w:IgnoreMixedContent>\r\n  <w:AlwaysShowPlaceholderText>false</w:AlwaysShowPlaceholderText>\r\n  <w:DoNotPromoteQF/>\r\n  <w:LidThemeOther>EN-US</w:LidThemeOther>\r\n  <w:LidThemeAsian>X-NONE</w:LidThemeAsian>\r\n  <w:LidThemeComplexScript>X-NONE</w:LidThemeComplexScript>\r\n  <w:Compatibility>\r\n   <w:BreakWrappedTables/>\r\n   <w:SnapToGridInCell/>\r\n   <w:WrapTextWithPunct/>\r\n   <w:UseAsianBreakRules/>\r\n   <w:DontGrowAutofit/>\r\n   <w:SplitPgBreakAndParaMark/>\r\n   <w:EnableOpenTypeKerning/>\r\n   <w:DontFlipMirrorIndents/>\r\n   <w:OverrideTableStyleHps/>\r\n  </w:Compatibility>\r\n  <m:mathPr>\r\n   <m:mathFont m:val="Cambria Math"/>\r\n   <m:brkBin m:val="before"/>\r\n   <m:brkBinSub m:val="&#45;-"/>\r\n   <m:smallFrac m:val="off"/>\r\n   <m:dispDef/>\r\n   <m:lMargin m:val="0"/>\r\n   <m:rMargin m:val="0"/>\r\n   <m:defJc m:val="centerGroup"/>\r\n   <m:wrapIndent m:val="1440"/>\r\n   <m:intLim m:val="subSup"/>\r\n   <m:naryLim m:val="undOvr"/>\r\n  </m:mathPr></w:WordDocument>\r\n</xml><![endif]-->\x3C!--[if gte mso 9]><xml>\r\n <w:LatentStyles DefLockedState="false" DefUnhideWhenUsed="false"\r\n  DefSemiHidden="false" DefQFormat="false" DefPriority="99"\r\n  LatentStyleCount="376">\r\n  <w:LsdException Locked="false" Priority="0" QFormat="true" Name="Normal"/>\r\n  <w:LsdException Locked="false" Priority="9" QFormat="true" Name="heading 1"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 2"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 3"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 4"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 5"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 6"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 7"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 8"/>\r\n  <w:LsdException Locked="false" Priority="9" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="heading 9"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 6"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 7"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 8"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index 9"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 1"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 2"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 3"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 4"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 5"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 6"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 7"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 8"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="toc 9"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Normal Indent"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="footnote text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="annotation text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="header"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="footer"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="index heading"/>\r\n  <w:LsdException Locked="false" Priority="35" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="caption"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="table of figures"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="envelope address"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="envelope return"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="footnote reference"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="annotation reference"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="line number"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="page number"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="endnote reference"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="endnote text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="table of authorities"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="macro"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="toa heading"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Bullet"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Number"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Bullet 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Bullet 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Bullet 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Bullet 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Number 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Number 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Number 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Number 5"/>\r\n  <w:LsdException Locked="false" Priority="10" QFormat="true" Name="Title"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Closing"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Signature"/>\r\n  <w:LsdException Locked="false" Priority="1" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="Default Paragraph Font"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text Indent"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Continue"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Continue 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Continue 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Continue 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="List Continue 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Message Header"/>\r\n  <w:LsdException Locked="false" Priority="11" QFormat="true" Name="Subtitle"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Salutation"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Date"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text First Indent"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text First Indent 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Note Heading"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text Indent 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Body Text Indent 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Block Text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Hyperlink"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="FollowedHyperlink"/>\r\n  <w:LsdException Locked="false" Priority="22" QFormat="true" Name="Strong"/>\r\n  <w:LsdException Locked="false" Priority="20" QFormat="true" Name="Emphasis"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Document Map"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Plain Text"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="E-mail Signature"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Top of Form"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Bottom of Form"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Normal (Web)"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Acronym"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Address"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Cite"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Code"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Definition"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Keyboard"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Preformatted"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Sample"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Typewriter"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="HTML Variable"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Normal Table"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="annotation subject"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="No List"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Outline List 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Outline List 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Outline List 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Simple 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Simple 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Simple 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Classic 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Classic 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Classic 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Classic 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Colorful 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Colorful 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Colorful 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Columns 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Columns 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Columns 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Columns 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Columns 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 6"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 7"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Grid 8"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 4"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 5"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 6"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 7"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table List 8"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table 3D effects 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table 3D effects 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table 3D effects 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Contemporary"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Elegant"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Professional"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Subtle 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Subtle 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Web 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Web 2"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Web 3"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Balloon Text"/>\r\n  <w:LsdException Locked="false" Priority="39" Name="Table Grid"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Table Theme"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" Name="Placeholder Text"/>\r\n  <w:LsdException Locked="false" Priority="1" QFormat="true" Name="No Spacing"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 1"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" Name="Revision"/>\r\n  <w:LsdException Locked="false" Priority="34" QFormat="true"\r\n   Name="List Paragraph"/>\r\n  <w:LsdException Locked="false" Priority="29" QFormat="true" Name="Quote"/>\r\n  <w:LsdException Locked="false" Priority="30" QFormat="true"\r\n   Name="Intense Quote"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="60" Name="Light Shading Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="61" Name="Light List Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="62" Name="Light Grid Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="63" Name="Medium Shading 1 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="64" Name="Medium Shading 2 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="65" Name="Medium List 1 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="66" Name="Medium List 2 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="67" Name="Medium Grid 1 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="68" Name="Medium Grid 2 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="69" Name="Medium Grid 3 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="70" Name="Dark List Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="71" Name="Colorful Shading Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="72" Name="Colorful List Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="73" Name="Colorful Grid Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="19" QFormat="true"\r\n   Name="Subtle Emphasis"/>\r\n  <w:LsdException Locked="false" Priority="21" QFormat="true"\r\n   Name="Intense Emphasis"/>\r\n  <w:LsdException Locked="false" Priority="31" QFormat="true"\r\n   Name="Subtle Reference"/>\r\n  <w:LsdException Locked="false" Priority="32" QFormat="true"\r\n   Name="Intense Reference"/>\r\n  <w:LsdException Locked="false" Priority="33" QFormat="true" Name="Book Title"/>\r\n  <w:LsdException Locked="false" Priority="37" SemiHidden="true"\r\n   UnhideWhenUsed="true" Name="Bibliography"/>\r\n  <w:LsdException Locked="false" Priority="39" SemiHidden="true"\r\n   UnhideWhenUsed="true" QFormat="true" Name="TOC Heading"/>\r\n  <w:LsdException Locked="false" Priority="41" Name="Plain Table 1"/>\r\n  <w:LsdException Locked="false" Priority="42" Name="Plain Table 2"/>\r\n  <w:LsdException Locked="false" Priority="43" Name="Plain Table 3"/>\r\n  <w:LsdException Locked="false" Priority="44" Name="Plain Table 4"/>\r\n  <w:LsdException Locked="false" Priority="45" Name="Plain Table 5"/>\r\n  <w:LsdException Locked="false" Priority="40" Name="Grid Table Light"/>\r\n  <w:LsdException Locked="false" Priority="46" Name="Grid Table 1 Light"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark"/>\r\n  <w:LsdException Locked="false" Priority="51" Name="Grid Table 6 Colorful"/>\r\n  <w:LsdException Locked="false" Priority="52" Name="Grid Table 7 Colorful"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="Grid Table 1 Light Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="Grid Table 2 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="Grid Table 3 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="Grid Table 4 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="Grid Table 5 Dark Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="Grid Table 6 Colorful Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="Grid Table 7 Colorful Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="46" Name="List Table 1 Light"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark"/>\r\n  <w:LsdException Locked="false" Priority="51" Name="List Table 6 Colorful"/>\r\n  <w:LsdException Locked="false" Priority="52" Name="List Table 7 Colorful"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 1"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 2"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 3"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 4"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 5"/>\r\n  <w:LsdException Locked="false" Priority="46"\r\n   Name="List Table 1 Light Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="47" Name="List Table 2 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="48" Name="List Table 3 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="49" Name="List Table 4 Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="50" Name="List Table 5 Dark Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="51"\r\n   Name="List Table 6 Colorful Accent 6"/>\r\n  <w:LsdException Locked="false" Priority="52"\r\n   Name="List Table 7 Colorful Accent 6"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Mention"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Smart Hyperlink"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Hashtag"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Unresolved Mention"/>\r\n  <w:LsdException Locked="false" SemiHidden="true" UnhideWhenUsed="true"\r\n   Name="Smart Link"/>\r\n </w:LatentStyles>\r\n</xml><![endif]-->\r\n<style>\r\n\x3C!--\r\n /* Font Definitions */\r\n @font-face\r\n\t{font-family:"Cambria Math";\r\n\tpanose-1:2 4 5 3 5 4 6 3 2 4;\r\n\tmso-font-charset:0;\r\n\tmso-generic-font-family:roman;\r\n\tmso-font-pitch:variable;\r\n\tmso-font-signature:-536869121 1107305727 33554432 0 415 0;}\r\n@font-face\r\n\t{font-family:Aptos;\r\n\tmso-font-charset:0;\r\n\tmso-generic-font-family:swiss;\r\n\tmso-font-pitch:variable;\r\n\tmso-font-signature:536871559 3 0 0 415 0;}\r\n /* Style Definitions */\r\n p.MsoNormal, li.MsoNormal, div.MsoNormal\r\n\t{mso-style-unhide:no;\r\n\tmso-style-qformat:yes;\r\n\tmso-style-parent:"";\r\n\tmargin-top:0in;\r\n\tmargin-right:0in;\r\n\tmargin-bottom:8.0pt;\r\n\tmargin-left:0in;\r\n\tline-height:107%;\r\n\tmso-pagination:widow-orphan;\r\n\tfont-size:11.0pt;\r\n\tfont-family:"Aptos",sans-serif;\r\n\tmso-ascii-font-family:Aptos;\r\n\tmso-ascii-theme-font:minor-latin;\r\n\tmso-fareast-font-family:Aptos;\r\n\tmso-fareast-theme-font:minor-latin;\r\n\tmso-hansi-font-family:Aptos;\r\n\tmso-hansi-theme-font:minor-latin;\r\n\tmso-bidi-font-family:"Times New Roman";\r\n\tmso-bidi-theme-font:minor-bidi;\r\n\tmso-font-kerning:1.0pt;\r\n\tmso-ligatures:standardcontextual;}\r\n.MsoChpDefault\r\n\t{mso-style-type:export-only;\r\n\tmso-default-props:yes;\r\n\tfont-size:11.0pt;\r\n\tmso-ansi-font-size:11.0pt;\r\n\tmso-bidi-font-size:11.0pt;\r\n\tfont-family:"Aptos",sans-serif;\r\n\tmso-ascii-font-family:Aptos;\r\n\tmso-ascii-theme-font:minor-latin;\r\n\tmso-fareast-font-family:Aptos;\r\n\tmso-fareast-theme-font:minor-latin;\r\n\tmso-hansi-font-family:Aptos;\r\n\tmso-hansi-theme-font:minor-latin;\r\n\tmso-bidi-font-family:"Times New Roman";\r\n\tmso-bidi-theme-font:minor-bidi;}\r\n.MsoPapDefault\r\n\t{mso-style-type:export-only;\r\n\tmargin-bottom:8.0pt;\r\n\tline-height:107%;}\r\n@page WordSection1\r\n\t{size:8.5in 11.0in;\r\n\tmargin:1.0in 1.0in 1.0in 1.0in;\r\n\tmso-header-margin:.5in;\r\n\tmso-footer-margin:.5in;\r\n\tmso-paper-source:0;}\r\ndiv.WordSection1\r\n\t{page:WordSection1;}\r\n-->\r\n</style>\r\n\x3C!--[if gte mso 10]>\r\n<style>\r\n /* Style Definitions */\r\n table.MsoNormalTable\r\n\t{mso-style-name:"Table Normal";\r\n\tmso-tstyle-rowband-size:0;\r\n\tmso-tstyle-colband-size:0;\r\n\tmso-style-noshow:yes;\r\n\tmso-style-priority:99;\r\n\tmso-style-parent:"";\r\n\tmso-padding-alt:0in 5.4pt 0in 5.4pt;\r\n\tmso-para-margin-top:0in;\r\n\tmso-para-margin-right:0in;\r\n\tmso-para-margin-bottom:8.0pt;\r\n\tmso-para-margin-left:0in;\r\n\tline-height:107%;\r\n\tmso-pagination:widow-orphan;\r\n\tfont-size:11.0pt;\r\n\tfont-family:"Aptos",sans-serif;\r\n\tmso-ascii-font-family:Aptos;\r\n\tmso-ascii-theme-font:minor-latin;\r\n\tmso-hansi-font-family:Aptos;\r\n\tmso-hansi-theme-font:minor-latin;\r\n\tmso-font-kerning:1.0pt;\r\n\tmso-ligatures:standardcontextual;}\r\n</style>\r\n<![endif]-->\r\n</head>\r\n\r\n<body lang=EN-US style='tab-interval:.5in;word-wrap:break-word'>\r\n\x3C!--StartFragment-->\r\n\r\n<p class=MsoNormal><o:p>&nbsp;</o:p></p>\r\n\r\n<p class=MsoNormal>Rich Text Editor<o:p></o:p></p>\r\n\r\n<p class=MsoNormal><span style='mso-no-proof:yes'>\x3C!--[if gte vml 1]><v:shapetype\r\n id="_x0000_t75" coordsize="21600,21600" o:spt="75" o:preferrelative="t"\r\n path="m@4@5l@4@11@9@11@9@5xe" filled="f" stroked="f">\r\n <v:stroke joinstyle="miter"/>\r\n <v:formulas>\r\n  <v:f eqn="if lineDrawn pixelLineWidth 0"/>\r\n  <v:f eqn="sum @0 1 0"/>\r\n  <v:f eqn="sum 0 0 @1"/>\r\n  <v:f eqn="prod @2 1 2"/>\r\n  <v:f eqn="prod @3 21600 pixelWidth"/>\r\n  <v:f eqn="prod @3 21600 pixelHeight"/>\r\n  <v:f eqn="sum @0 0 1"/>\r\n  <v:f eqn="prod @6 1 2"/>\r\n  <v:f eqn="prod @7 21600 pixelWidth"/>\r\n  <v:f eqn="sum @8 21600 0"/>\r\n  <v:f eqn="prod @7 21600 pixelHeight"/>\r\n  <v:f eqn="sum @10 21600 0"/>\r\n </v:formulas>\r\n <v:path o:extrusionok="f" gradientshapeok="t" o:connecttype="rect"/>\r\n <o:lock v:ext="edit" aspectratio="t"/>\r\n</v:shapetype><v:shape id="Picture_x0020_4" o:spid="_x0000_i1025" type="#_x0000_t75"\r\n alt="A foggy landscape with hills and trees&#10;&#10;Description automatically generated"\r\n style='width:384pt;height:4in;visibility:visible;mso-wrap-style:square'>\r\n <v:imagedata src="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_image001.jpg"\r\n  o:title="A foggy landscape with hills and trees&#10;&#10;Description automatically generated"/>\r\n</v:shape><![endif]--><![if !vml]><img width=512 height=384\r\nsrc="file:///C:/Users/DHANES~1/AppData/Local/Temp/msohtmlclip1/01/clip_image002.jpg"\r\nalt="A foggy landscape with hills and trees&#10;&#10;Description automatically generated"\r\nv:shapes="Picture_x0020_4"><![endif]></span><o:p></o:p></p>\r\n\r\n\x3C!--EndFragment-->\r\n</body>\r\n\r\n</html>\r\n`;
            keyBoardEvent.clipboardData = {
                getData: () => {
                    return localElem;
                },
            ...
            setTimeout(() => {
                ...
                expect((rteObj as any).inputElement.querySelectorAll('img').toBeNull);
                done();
            }, 500);
        });
        it("Prevent pasting images from FileManager other than the allowed types", (done) => {
            keyBoardEvent.clipboardData = {
                getData: () => { return `<html> <body> <!--StartFragment--><p>content<br/> <img class='pasteContent_Img' src='' /></p><!--EndFragment--> </body></html>` },
                types: ['text/html', 'Files'],
                files: { 0: { lastModified: 1594563447084, name: "image.png", size: 66216, type: "image/png", webkitRelativePath: "", lastModifiedDate: new Date() } },
            ...
            rteObj.pasteCleanupSettings.deniedAttrs = [];
            rteObj.pasteCleanupSettings.allowedStyleProps = [];
            rteObj.insertImageSettings.allowedTypes =['.jpg'];
            rteObj.dataBind();
            (rteObj as any).inputElement.focus();
            setCursorPoint((rteObj as any).inputElement.firstElementChild, 0);
            rteObj.onPaste(keyBoardEvent);
        ...
        it("Prevent pasting images from web other than the allowed types", (done) => {
            keyBoardEvent.clipboardData = {
                getData: () => { return `"<img src=\"https://cdn.syncfusion.com/content/images/company-logos/Syncfusion_Logo_Image.png\" alt=\"Image result for syncfusion\" class=\"e-resize e-img-focus\">";` },
                types: ['text/html', 'Files'],
                files: { 0: { lastModified: 1594563447084, name: "image.png", size: 66216, type: "image/png", webkitRelativePath: "", lastModifiedDate: new Date() } },
                items: { 0: { kind: 'string', type: 'text/html' }, 1: { kind: 'file', type: 'image/png' }, }
            };
    ...
    describe('1012687 - Script Error When Pasting Nested List Content from Word in Paste Cleanup Sample', () => {
        let editor: RichTextEditor;
        beforeEach((done: DoneFn) => {
            editor = renderRTE({
                pasteCleanupSettings: {
        ...
        it('New list item should be created with listStyleType as none when list elements as nested list items', (done: DoneFn) => {
            editor.focusIn();
            var element: Node = editor.inputElement.firstChild;
            setCursorPoint(element as Element, 0);
            const clipBoardData: string = `<ul style="margin-bottom: 0in; margin-top: 0in;" type="disc"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><b>Welcome to the Syncfusion Rich Text Editor</b></li></ul><ul style="margin-bottom: 0in; list-style-type: none;"><li><ul level="2" style="margin-bottom: 0in; list-style-type: circle;"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><p>The Rich Text Editor, a WYSIWYG (what you see is what you get) editor, is a user interface that allows you to create, edit, and format rich text content. You can try out a demo of this editor here.</p></li></ul></li></ul><ul style="margin-bottom: 0in; margin-top: 0in;" type="disc"><ul style="margin-bottom: 0in; margin-top: 0in;" type="circle"><ul style="margin-bottom: 0in; margin-top: 0in;" type="square"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><b>Do you know the key features of the editor?</b></li><ul style="margin-bottom: 0in; margin-top: 0in;" type="square"><ul style="margin-bottom: 0in; margin-top: 0in;" type="square"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">Basic features include headings, block quotes, numbered lists, bullet lists, and support to insert images, tables, audio, and video.</li></ul></ul><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">Inline styles include <b>bold</b>, <i>italic</i>, <u>underline</u>, strikethrough, <a href="https://blazor.syncfusion.com/demos/rich-text-editor/overview?theme=material3" title="https://blazor.syncfusion.com/demos/rich-text-editor/overview?theme=material3">hyperlinks</a>,InlineCode and more.</li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">The toolbar has multi-row, expandable, and scrollable modes. The Editor supports an inline toolbar, a floating toolbar, and custom toolbar items.</li><ul style="margin-bottom: 0in; margin-top: 0in;" type="square"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">Integration with Syncfusion Mention control lets users tag other users. To learn more, check out the <a href="https://blazor.syncfusion.com/documentation/mention/getting-started-webapp" title="Mention Documentation">documentation</a> and <a href="https://blazor.syncfusion.com/demos/rich-text-editor/mention-integration?theme=material3" title="Mention Demos">demos</a>.</li></ul></ul></ul><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><b>Paste from MS Word</b> - helps to reduce the effort while converting the Microsoft Word content to HTML format with format and styles. To learn more, check out the documentation <a href="https://blazor.syncfusion.com/documentation/rich-text-editor/paste-cleanup" title="Paste from MS Word Documentation">here</a>.</li><ul style="margin-bottom: 0in; margin-top: 0in;" type="circle"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">Other features: placeholder text, character count, form validation, enter key configuration, resizable editor, IFrame rendering, tooltip, source code view, RTL mode, persistence, HTML Sanitizer, autosave, and <a href="https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.RichTextEditor.SfRichTextEditor.html" title="Rich Text Editor API">more</a>.</li><ul style="margin-bottom: 0in; margin-top: 0in;" type="square"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><b>Auto Formatting - Write Faster, Format Smarter</b></li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">Boost your productivity with Auto Formatting, a powerful feature that lets you style content instantly using simple, familiar Markdown-style shortcuts. No need to reach for the toolbar - just type and watch your content transform in real time.</li><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><b>Effortless Formatting Shortcuts</b></li></ul></ul></ul><ul style="margin-bottom: 0in; margin-top: 0in;" type="disc"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;">manage your images on the server by configuring the <a href="https://blazor.syncfusion.com/documentation/rich-text-editor/tools/insert-image" title="Insert Image Settings API">insertImageSettings</a> to upload, save, or remove them.</li></ul><ul style="margin-bottom: 0in; margin-top: 0in;" type="disc"><li style="margin-top: 0in; margin-right: 0in; margin-bottom: 8pt; line-height: 115%; font-size: 12pt; font-family: Aptos, sans-serif;"><i>Easily access Audio, Image, Link, Video, and Table operations through the quick toolbar by right-clicking on the corresponding element with your mouse.</i></li></ul>`;
            const dataTransfer: DataTransfer = new DataTransfer();
            dataTransfer.setData('text/html', clipBoardData);
            const pasteEvent: ClipboardEvent = new ClipboardEvent('paste', { clipboardData: dataTransfer } as ClipboardEventInit);
            editor.onPaste(pasteEvent);
            setTimeout(() => {
                var pastedElm = editor.inputElement.querySelectorAll("ul")[3].firstChild;
                expect((pastedElm as HTMLElement).style.listStyleType).toBe('none');
                done();
            }, 100);
        });
    });
    ...
    describe('931044 - After Pasting an Image, the afterPasteCleanup Event Does Not Get Triggered.', () => {
        ...
        it ('Should not remove the image from the DOM. CASE 2: Relative URL.', (done: DoneFn) => {
            editor.focusIn();
            const clipBoardData: string = '\x3C!--StartFragment--><p style="margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, &quot;sans-serif&quot;, -apple-system, BlinkMacSystemFont; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Image with Width and Height</p><p style="margin: 0px 0px 10px; color: rgb(51, 51, 51); font-family: Roboto, &quot;Segoe UI&quot;, GeezaPro, &quot;DejaVu Serif&quot;, &quot;sans-serif&quot;, -apple-system, BlinkMacSystemFont; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><img alt="image 1" src="./images/RTEImage-Feather.png" class="e-rte-image e-img-inline" style="border: 0px; cursor: pointer; display: inline-block; float: none; margin: auto 5px; max-width: 100%; position: relative; box-sizing: border-box; padding: 1px; vertical-align: bottom; z-index: 1000; width: 450px; height: 300px;"></p><br class="Apple-interchange-newline">\x3C!--EndFragment-->';
            const dataTransfer: DataTransfer = new DataTransfer();
            dataTransfer.setData('text/html', clipBoardData);
            const pasteEvent: ClipboardEvent = new ClipboardEvent('paste', { clipboardData: dataTransfer } as ClipboardEventInit);
            editor.onPaste(pasteEvent);
    ...
    describe("925901 - Table gets deleted when hit the enter key", () => {
        ...
        it("Paste content to RTE table and then pressing the enter key table gets deleted", (done) => {
          ...
          setTimeout(() => {
            let pastedElm: any = (rteObj as any).inputElement.innerHTML;
            let expected: boolean = false;
            // Need to resolve the focus issue while coping a table from thee oneNote, focus should occur similar to word copy past
            let expectedElem: string = `<p><b>Description:</b></p><div style="direction: ltr;"><table border="1" cellpadding="0" cellspacing="0" valign="top" title="" summary="" style="direction: ltr; border-style: solid; border-width: 1pt;" class="e-rte-paste-table"><tbody><tr><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.6673in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p></td><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.6673in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p></td><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.5in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p></td></tr><tr><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.6673in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p></td><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.6673in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p></td><td style="border-style: solid; border-width: 1pt; vertical-align: top; width: 0.5in; padding: 4pt;"><p style="margin: 0in; font-family: Calibri; font-size: 11pt;">&nbsp;</p><p style="margin: 0in; font-family: Calibri; font-size: 11pt;"><br></p></td></tr></tbody></table></div><p class="custom">The Rich Text Editor (RTE) control is an easy to render in client side.</p>`;
            if (pastedElm === expectedElem) {
              expected = true;
            }
            expect(expected).toBe(true);
   ...
   describe('948219: Paste as Plain Text context menu action shows the Paste dialog CASE 2.', ()=> {
    ...
    describe("933393 - Plain paste at the end of the line creates empty para issue resolved", () => {
        let rteObj: RichTextEditor;
        beforeAll((done: Function) => {
            rteObj = renderRTE({
                value: `<p><b>Description:</b></p><p class="custom">The Rich Text Editor (RTE) control is an easy to render in client side.</p>`,
        ...
        it("Empty para should not be created when pasting ", (done) => {
            const clipBoardData: string = `To analyze, optimize, and enhance the readability of the insert logic, excluding pasteHTML and insertHTML`;
            const dataTransfer: DataTransfer = new DataTransfer();
            ...
            rteObj.pasteCleanupSettings.allowedStyleProps = [];
            rteObj.dataBind();
            let focusNode: Node = (rteObj as any).inputElement.querySelector('.custom').childNodes[0]
            rteObj.formatter.editorManager.nodeSelection.setSelectionText(document, focusNode, focusNode, 71, 71);
            rteObj.onPaste(pasteEvent);
            setTimeout(() => {
                let pastedElm: any = (rteObj as any).inputElement.innerHTML;
                let expected: boolean = true;
                let expectedElem: string = `<p><b>Description:</b></p><p class="custom">The Rich Text Editor (RTE) control is an easy to render in client side.To analyze, optimize, and enhance the readability of the insert logic, excluding&nbsp;pasteHTML&nbsp;and&nbsp;insertHTML</p>`;
                if (pastedElm !== expectedElem) {
                    expected = false;
                }
                expect(expected).toBe(true);
                expect(rteObj.inputElement.querySelectorAll('p:empty').length === 0).toBe(true);
                done();
            }, 100);
        });
    ...
    describe('Should not merge inline span with existing anchor during paste', () => {
        ...
        beforeAll(() => {
            rteObj = renderRTE({
                value: `<p><a href="https://www.syncfusion.com/" id="start">Syncfusion</a></p>`
            });
        });
        afterAll(() => {
            destroy(rteObj);
        });
        it('should paste span content outside the existing anchor', (done: DoneFn) => {
            const anchor: HTMLElement = document.getElementById('start');
            const selection = new NodeSelection();
            if (anchor && anchor.firstChild) {
                selection.setCursorPoint(document, anchor.firstChild as Element, (anchor.firstChild as Element).textContent.length);
            }
            const dataTransfer = new DataTransfer();
            dataTransfer.setData('text/html', clipboardHtml);
...
<p class="p2"><br></p>
     ...
     describe('971761 - Cursor jumps to incorrect position after pasting an image from Clipboard into Rich Text Editor', () => {
        let rteObj: RichTextEditor;
        const clipboardHtml: string = `<img id="rteImageID" style="width: 300px; height: 300px; transform: rotate(0deg);" alt="Editor Features Overview" src="https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Portrait.png" class="e-rte-image e-img-inline">`;
        beforeAll(() => {
            rteObj = renderRTE({
    ...
    describe("979944: List corruption when enterKey is set to 'div' and pasting multiple lines in RichTextEditor", () => {
        ...
        it("Should paste list after list item and maintain structure (First Paste)", (done: DoneFn) => {
            ...
            rteObj.onPaste(pasteEvent);
            setTimeout(() => {
                expect(rteObj.inputElement.innerHTML === `<div>First line</div><div>Second Line</div><div><ul style="list-style-type: disc;"><li>List one</li><li>List one</li><li>List two</li><li>List two</li></ul></div>`).toBe(true);
                done();
            }, 200);
        });
        ...
        it("Should paste list in mid position of list item and maintain structure ", (done: DoneFn) => {
            ...
            rteObj.onPaste(pasteEvent);
            setTimeout(() => {
                expect(rteObj.inputElement.innerHTML === `<div>First line</div><div>Second Line</div><div><ul style="list-style-type: disc;"><li>List </li><li>List one</li><li>List two</li><li>one</li><li>List two</li></ul></div>`).toBe(true);
                done();
            }, 200);
        });
        afterAll((done: DoneFn) => {
   ...
   <li>Other features: placeholder text, character count, form validation, enter key configuration, resizable editor, IFrame rendering, tooltip, source code view, RTL mode, persistence, HTML Sanitizer, autosave, and <a class="e-rte-anchor" href="https://ej2.syncfusion.com/documentation/api/rich-text-editor/" title="Rich Text Editor API" aria-label="Open in new window">more</a>.</li>
    ...
    describe('PasteCleanup popup and uploader code coverage -', () => {
        ...
        beforeAll(() => {
            rteObj = renderRTE({
                ...
                value: `<h1 style="cursor: auto;">Welcome to the Syncfusion Rich Text<img src="blob:null/33ba739c-99a3-44fe-b430-3f7004cd0d03" class="e-rte-image e-img-inline" alt="image" width="229" height="127" style="min-width: 0px; max-width: 1535px; min-height: 0px; width: 229px; height: 127px;"/> </h1>`,
            });
        ...
        it(' Uploader Canceling use case', () => {
            rteObj.inputElement.innerHTML = `<h1 style="cursor: auto;">Welcome to the Syncfusion Rich Text<img src="blob:null/33ba739c-99a3-44fe-b430-3f7004cd0d03" class="e-rte-image e-img-inline" alt="image" width="229" height="127" style="min-width: 0px; max-width: 1535px; min-height: 0px; width: 229px; height: 127px;"/> </h1>`;
            let imgElement = document.createElement('img');
            const imgFile = getImageUniqueFIle();
            const imgPopup = pasteCleanupModuleRef.createPopupObject(imgElement, imgFile);
            const imgUploader = pasteCleanupModuleRef.createUploader(imgElement, imgPopup, imgFile);
    ...
    describe('1005441 - ExtractFileFromClipboard filters files based on allowed type', () => {
        it('should extract only allowed files from clipboard items', () => {
            const file1 = new File(['dummy'], 'image1.jpg', { type: 'image/jpeg' });
            const file2 = new File(['dummy'], 'image2.png', { type: 'image/png' });
            const file3 = new File(['dummy'], 'video1.mp4', { type: 'video/mp4' });
            const clipboardItems: Array<{ kind: string; getAsFile: () => File | null }> = [
                { kind: 'file', getAsFile: () => file1 },
                { kind: 'file', getAsFile: () => file2 },
                { kind: 'file', getAsFile: () => file3 },
                { kind: 'string', getAsFile: () => null }
            ];
            const clipboardData: any = { items: clipboardItems };
            const args: any = { clipboardData };
            const notifyArgs = { args } as any;
            const pasteModel: any = {
                insertImageSettings: { allowedTypes: ['.jpg', '.png'] },
            ...
            const pasteCleanupAction = new PasteCleanupAction(mockParent, pasteModel);
            const result: File[] = pasteCleanupAction.extractFileFromClipboard(notifyArgs);
            expect(result.length).toBe(2);
            expect(result[0].name).toBe('image1.jpg');
            expect(result[1].name).toBe('image2.png');
        });
        it('should return empty array if no allowed files are present', () => {
            const file1 = new File(['dummy'], 'video1.mp4', { type: 'video/mp4' });
            const clipboardItems: Array<{ kind: string; getAsFile: () => File | null }> = [
                { kind: 'file', getAsFile: () => file1 }
            ];
            const clipboardData: any = { items: clipboardItems };
            const args: any = { clipboardData };
            const notifyArgs: any = { args } as any;
            const pasteModel: any = {
                insertImageSettings: { allowedTypes: ['.jpg'] },
                insertVideoSettings: { allowedTypes: [] },
                insertAudioSettings: { allowedTypes: [] }
            };
            const mockParent: any = {
    ...
    describe('1014427: Image class normalization after paste action', () => {
        let rteObj: RichTextEditor;
        beforeAll(()=> {
            rteObj = renderRTE({
                pasteCleanupSettings: {
        ...
        it("Paste image caption normalization", (done: DoneFn) => {
            const pasteHtml: string = `<html>\r\n<body>\r\n\x3C!--StartFragment--><h3>Elevating Your Content with Images</h3><p> Images can be added to the editor by pasting or dragging into the editing area, using the toolbar to insert one as a URL, or uploading directly from the File Browser. Easily manage your images on the server by configuring the <a class="e-rte-anchor" href="https://ej2.syncfusion.com/documentation/api/rich-text-editor/#insertimagesettings" title="Insert Image Settings API" aria-label="Open in new window">insertImageSettings</a> to upload, save, or remove them. </p><p> The Editor can integrate with the Syncfusion<sup>®</sup> Image Editor to crop, rotate, annotate, and apply filters to images. Check out the demos <a class="e-rte-anchor" href="https://ej2.syncfusion.com/demos/#/material/rich-text-editor/image-editor-integration.html" title="Image Editor Demo" aria-label="Open in new window">here</a>. </p><p><span class="e-img-caption e-rte-img-caption e-imgbreak e-imgleft" contenteditable="false" draggable="false" style="width:auto"><span class="e-img-wrap"><img alt="Sky with sun" src="https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Overview.png" class="e-rte-image e-imgleft"><span class="e-img-inner" contenteditable="true">Caption</span></span></span></p><blockquote style="clear: right;"> <p><em>Easily access Audio, Image, Link, Video, and Table operations through the quick toolbar by right-clicking on the corresponding element with your mouse.</em></p></blockquote>\x3C!--EndFragment-->\r\n</body>\r\n</html>`;
        ...
        it("Paste standalone image normalization", (done: DoneFn) => {
            const pasteHtml: string = `<html>\r\n<body>\r\n\x3C!--StartFragment--><h3>Elevating Your Content with Images</h3><p> Images can be added to the editor by pasting or dragging into the editing area, using the toolbar to insert one as a URL, or uploading directly from the File Browser. Easily manage your images on the server by configuring the <a class="e-rte-anchor" href="https://ej2.syncfusion.com/documentation/api/rich-text-editor/#insertimagesettings" title="Insert Image Settings API" aria-label="Open in new window">insertImageSettings</a> to upload, save, or remove them. </p><p> The Editor can integrate with the Syncfusion<sup>®</sup> Image Editor to crop, rotate, annotate, and apply filters to images. Check out the demos <a class="e-rte-anchor" href="https://ej2.syncfusion.com/demos/#/material/rich-text-editor/image-editor-integration.html" title="Image Editor Demo" aria-label="Open in new window">here</a>. </p><p><img alt="Sky with sun" src="https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Overview.png" style="width: 440px;" class="e-rte-image e-imgright"></p><blockquote style="clear: right;"> <p><em>Easily access Audio, Image, Link, Video, and Table operations through the quick toolbar by right-clicking on the corresponding element with your mouse.</em></p></blockquote>\x3C!--EndFragment-->\r\n</body>\r\n</html>`;
            rteObj.inputElement.focus();
            setCursorPoint(rteObj.inputElement.firstElementChild, 0);
            const dataTransfer2 = new DataTransfer();
            dataTransfer2.setData('text/html', pasteHtml);
            const pasteEvent2: ClipboardEvent = new ClipboardEvent('paste', { clipboardData: dataTransfer2 } as ClipboardEventInit);
            rteObj.inputElement.dispatchEvent(pasteEvent2);
            setTimeout(() => {
                const img = rteObj.inputElement.querySelector('img') as HTMLImageElement;
                expect(img.classList.contains('e-rte-image')).toBe(true);
                expect(img.classList.contains('e-img-right')).toBe(true);
                expect(img.classList.contains('e-imgright')).toBe(false);
                done();
            }, 100);
        });
    });
