...
describe('Formats plugin', () => {
    let innerHTML: string = `<div style="color:red;" id="content-edit" contenteditable="true" class="e-node-deletable e-node-inner">
    ...
    describe(' BlockQuote Formats testing', () => {
        ...
        it(' - select all content and applying blockquote', () => {
            let rteContent: string = `<p id="startNode">Content 1</p><p>Content 2</p><p>Content 3</p><p>Content 4</p><p id="endNode">Content 5</p>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = rteContent;
    ...
    describe("BlockQuote Bugs", () => {
        ...
        it('914424: The reverting operation does not work correctly after using block quotation combination of both normal and list areas, Reverting the blockquotes for the list with blockquotes', (done: DoneFn) => {
        ...
        it('Blockquote action not functioning for div', (done: DoneFn) => {
            let content: string = `<div><p>The Rich Text Editor component is a WYSIWYG ('what you see is what you get') editor that provides the best user experience to create and update the content. Users can format their content using standard toolbar commands.</p><p><b>Key features:</b></p></div>`;
            rteEle = rteObj.element;
            rteObj.inputElement.innerHTML = content;
    ...
    describe(' Pre Formats testing', () => {
        ...
        it('Apply pre to List with out P tag in list', () => {
            let tableContent: string = `<ol><li class="l1">list1</li><li>list2</li><li class="l3">list3</li></ol>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it('select all with last element as table', () => {
            let tableContent: string = `<p id='p1'>Paragraph 1</p><p id='p2'>Paragraph 2</p><p id='p3'>Paragraph 3</p><table><tbody><tr><td>cell 1 1</td><td>cell 1 2</td></tr><tr><td>cell 2 1</td><td id="lastCell">Cell 2 2</td></tr></tbody></table>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
    ...
    describe(' Pre format Enter key testing', () => {
        ...
        it('Enter key at the start of the pre text', () => {
            let tableContent: string = `<p id="prePara">previous paragraph</p><pre id='p1'>Paragraph 1<br>Paragraph 2</pre><p id="nextPara">Paragraph</p>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
        ...
        it('Enter key at the middle of the pre text with style and span inside', () => {
            let tableContent: string = `<pre><span;">span 1</span><br><span>span 2</span><br><span>span 3</span><br><br><span id="selectSpan">revanth﻿﻿</span><br><span>span 5</span></pre>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
        ...
        it('Pre format Enter key with list as parent testing, Enter key at the end of the list', () => {
            let tableContent: string = `<ol><li><pre id='listPre'>para</pre></li></ol>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
        ...
        it('Empty pre format with testing, Enter key press when pre is empty', () => {
    ...
    describe('Heding Formats testing', () => {
        let editorObj: EditorManager;
        ...
        it(' Header 1 Formats testing, apply h1 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it(' Header 2 Formats testing, apply h2 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it(' Header 3 Formats testing, apply h3 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it(' Header 4 Formats testing, apply h4 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it(' Header 5 Formats testing, apply h5 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it(' Header 6 Formats testing, apply h6 format', () => {
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
        ...
        it('Header 6 Formats testing, select all with last element as table', () => {
            let tableContent: string = `<p id='p1'>Paragraph 1</p><p id='p2'>Paragraph 2</p><p id='p3'>Paragraph 3</p><table><tbody><tr><td>cell 1 1</td><td>cell 1 2</td></tr><tr><td>cell 2 1</td><td id="lastCell">Cell 2 2</td></tr></tbody></table>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
            let start: HTMLElement = elem.querySelector('#p1');
        ...
        it('Apply heading format with content having commensts tag testing, select all with last element as table', () => {
            let tableContent: string = `<p id="p1">The rich text editor is WYSIWYG ("what you see is what you get") editor useful to create and edit content, and return the valid <!-- /react-text --><a href="https://ej2.syncfusion.com/home/" target="_blank">HTML markup</a><!-- react-text: 30 --> or <!-- /react-text --><a href="https://ej2.syncfusion.com/home/" target="_blank">markdown</a><!-- react-text: 32 --> of the content<!-- /react-text --></p><!-- react-text: 33 --> <!-- /react-text --><p id="lastPara">Toolbar</p>`;
            let elem: HTMLElement = editorObj.editableElement as HTMLElement;
            elem.innerHTML = tableContent;
            let start: HTMLElement = elem.querySelector('#p1');
