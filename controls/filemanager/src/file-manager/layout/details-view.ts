...
export class DetailsView {
    ...
    private onDataBound(): void {
        ...
        if (typeof this.nextFocusIndex === 'number') {
            const rowCount: number = this.gridObj.getRows().length;
            if (rowCount > 0) {
    ...
    private onPathChanged(args: ReadArgs): void {
        ...
        if (this.parent.view === 'Details') {
            ...
            if ((this.parent as any)._lastFocused && this.parent.pathId && this.parent.pathId.length) {
                ...
                if (mappedId) {
                    const gridItems: Object[] = getSortedData(this.parent, args.files);
                    for (let i: number = 0; i < gridItems.length; i++) {
                        // eslint-disable-next-line security/detect-object-injection
                ...
                if (getValue('isFile', data)) {
                    ...
                    if (val === '' && !this.parent.isFiltered) {
                        if (this.parent.pathId && this.parent.pathId.length) {
                            (this.parent as any)._lastFocused = Object.assign((this.parent as any)._lastFocused || {}, { [this.parent.pathId[this.parent.pathId.length - 1]]: getValue('_fm_id', data) || getValue('id', data) || name });
                        }
    ...
    private onDeleteInit(): void {
        if (this.parent.activeModule === 'detailsview') {
            const selectedIndex: number = this.gridObj.selectedRowIndex;
     ...
     * @hidden
     */
    public addFocus(item: number | null): void {
