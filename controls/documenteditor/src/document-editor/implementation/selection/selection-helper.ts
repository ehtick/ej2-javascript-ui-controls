...
import {
    ...
    FieldElementBox, BlockWidget, BlockContainer, BookmarkElementBox, DocumentHelper, CommentCharacterElementBox, ContentControl
} from '../index';
    ...
    public validateBackwardFieldSelection(currentIndex: string, selectionEndIndex: string): void {
        ...
        if ((this.selection.start.paragraph !== this.selection.end.paragraph
            ...
            || (((isNullOrUndefined(this.selection.start.paragraph.previousRenderedWidget)
                ...
                && !(this.selection.start.paragraph.isInsideTable && isNullOrUndefined(this.selection.start.paragraph.nextRenderedWidget)))) {
