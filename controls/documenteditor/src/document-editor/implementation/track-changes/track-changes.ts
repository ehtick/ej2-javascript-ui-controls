...
export class Revision {
    ...
    public getContent(): string {
        ...
        if (!isNullOrUndefined(this.owner.trackChangesPane.changes.get(this))) {
            const currentChangeView = this.owner.trackChangesPane.changes.get(this);
            if (!isNullOrUndefined(this.owner.revisions.groupedView.get(currentChangeView))) {
                const revisions: Revision[] = this.owner.revisions.groupedView.get(currentChangeView);
                ...
                currentChangeView.layoutElementText(this, ranges, div, true);
