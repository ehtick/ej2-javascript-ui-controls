...
$rte-dropdown-transition-color: $secondary-text-color-hover !default;
...
$rte-emoji-pop-border: 1px solid $secondary-text-color-hover;
...
$rte-quick-toolbar-tip-pointer-content: $content-bg-color !default;
...
$rte-quick-popup-border-radius: $radius-0 !default;
