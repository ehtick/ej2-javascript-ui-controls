...
$rte-content-blockquote-border-left-color: solid 3px $content-text-color !default;
...
$rte-quick-popup-border: 1px solid $border-primary !default;
...
$rte-code-block-label-font-family: Inter !default;
...
$rte-quick-toolbar-tip-pointer-border: $border-secondary !default;
...
$rte-checklist-checked-border-color: 1px solid var(--branding-brand-primary, rgba(126, 86, 216, 1)) !default;
$rte-checklist-checked-checkmark-color: $white !default;
$rte-checklist-checkbox-border: 1px solid var(--border-border-primary, rgba(208, 213, 221, 1));
...
$rte-toolbar-item-hov-bg-color: $content-bg-color-alt4;
