...
$rte-table-popup-min-height: 160px !default;
$rte-table-popup-border: 1px solid $neutral-light !default;

$rte-big-quick-item-btn-width: 50px !default;
$rte-big-quick-item-btn-height: 50px !default;
...
$rte-quick-item-active-bg: rgba($neutral-black, .12) !default;
$rte-quick-item-active-font-color: $neutral-light-fontalt !default;
$rte-quick-item-hover-border-color: $neutral-white !default;
$rte-quick-item-active-border-color: $neutral-white !default;
$font-weight: 500 !default;
$rte-table-popup-border-radius: 0 !default;
$rte-qt-item-btn-line-height: 32px;
$rte-default-btn-bg: $neutral-white !default;
$rte-split-btn-border-radius: 0 !default;
$rte-split-btn-height: 40px !default;
$rte-big-split-btn-height: 50px !default;
$rte-hover-btn-border-color: $hover-border-color !default;
$rte-active-btn-icons-color: $theme-light-font !default;
$rte-default-icon-color: $neutral-light-font !default;
$rte-icon-color: $neutral-light-font !default;
$rte-hover-split-btn-border: 1px solid transparent !default;
$rte-split-btn-border: 1px solid transparent !default;
$rte-button-focus-box-shadow: none !default;

$rte-quick-pop-border: 0 !default;
$rte-quick-tb-border: 0 !default;
$rte-quick-pop-bg: $neutral-white !default;
$rte-quick-vr-line-color: rgba($neutral-black, .05) !default;
$rte-quick-pop-item-focus-bg: rgba($neutral-black, .12) !default;
$rte-quick-tb-btn-hover: rgba($neutral-black, .12) !default;
$rte-mob-drop-down-pop-shadow: rgba($neutral-black, .12) !default;

$rte-tb-items-margin-left: 4px !default;
$rte-big-active-tb-item-btn-padding: 0 !default;
$rte-active-tb-item-btn-padding: 0 !default;
$rte-tb-item-active-bg: rgba($neutral-black, .12) !default;
$rte-tb-active-font-color: $neutral-light-fontalt !default;
$rte-tb-item-active-border: 0 !default;
$rte-expand-tb-border-bottom: $rte-border-size $rte-border-type rgb(255, 255, 255) !default;
$rte-color-picker-active-bg: inherit !default;
$rte-drop-btn-active-bg: $neutral-tertiary-alt !default;
...
$rte-split-btn-hover-bg: $neutral-lighter !default;
$rte-split-btn-span-hover-bg: $neutral-light !default;
$rte-split-btn-focus-bg: $neutral-lighter !default;
$rte-btn-active-bg: rgba(0, 0, 0, .12) !default;
$rte-split-btn-active-color-icon-line-height: 40px !default;
$rte-dropdown-color: $neutral-light-font !default;
$rte-dropdown-transition-color: $neutral-light-fontalt !default;
$rte-color-picker-line-height: 1 !default;
$rte-popup-item-min-height: 40px !default;
$rte-big-popup-item-min-height: 50px !default;
$rte-popup-bg: $neutral-white !default;

$rte-table-multicell-select-bg-color: rgba($theme-primary, .08) !default;
$rte-insert-icon-color: $theme-primary !default;
...
$rte-upload-drag-border-clr: $neutral-quintenaryalt !default;
...
$rte-content-blockquote-border-left-color: solid 3px #d9d9d9 !default;
$rte-dropdown-selection-bgcolor: $neutral-tertiary-alt !default;
...
$rte-dropdown-selection-color: $neutral-primary !default;
...
$rte-table-header-color: rgba($neutral-light-font, .87) !default;
$rte-table-span-bg-color: $neutral-white !default;
$rte-table-span-border: 1px solid $neutral-tertiary-alt !default;
$rte-table-span-active-bg-color: rgba($theme-primary, .2) !default;
...
$rte-quick-popup-border-radius: 0 !default;
$rte-quick-popup-outer-margin: 0 3px !default;
$rte-quick-popup-inner-padding: 0 1px !default;
$rte-quick-big-popup-outer-margin: 0 4px !default;
$rte-quick-big-popup-inner-padding: 0 1px !default;
$rte-quick-popup-bg-color: $neutral-white !default;
...
$rte-big-emoji-btn-height: 252px;
...
$rte-dialog-upload-status-progress: #0378d5 !default;
...
$rte-quick-toolbar-tip-pointer-border: $neutral-white !default;
$rte-quick-toolbar-tip-pointer-content: inherit !default;
$rte-quick-popup-filter-color: rgba(0, 0, 0, .15) !default;
...
$rte-popup-padding: 0 3px !default;
$rte-popup-item-padding: 1px 1px !default;

$rte-checklist-checked-bg-color: $theme-primary !default;
$rte-checklist-checked-border-color: 1px solid $theme-primary !default;
$rte-checklist-checked-checkmark-color: $theme-primary-font !default;
$rte-checklist-checkbox-border: 1px solid rgba(118, 118, 118, 1);

$rte-ai-assistant-btn-disabled: $neutral-tertiary !default;
$rte-ai-assistant-box-shadow: 0 0 5px rgba($shadow, .4) !default;

$rte-toolbar-item-hov-bg-color: $neutral-lighter;
...
$rte-emoji-pop-border-radius: 2px !default;
...
$rte-expended-nav-min-height: 39px;
$rte-big-expended-nav-min-height: 49px;
