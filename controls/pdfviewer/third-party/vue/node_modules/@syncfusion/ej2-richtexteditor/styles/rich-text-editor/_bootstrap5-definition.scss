...
$rte-table-popup-border-radius: 6px !default;
...
$rte-quick-popup-outer-margin: 4px 8px !default;
$rte-quick-popup-inner-padding: 0 4px !default;
$rte-quick-big-popup-outer-margin: 4px 12px !default;
$rte-quick-big-popup-inner-padding: 0 4px !default;
$rte-quick-popup-bg-color: $content-bg-color !default;
...
$rte-split-btn-span-hover-bg: $content-text-color-alt3 !default;
$rte-split-btn-focus-bg: $secondary-bg-color-focus !default;
$rte-btn-active-bg:  $content-text-color-alt3 !default;
$rte-split-btn-active-color-icon-line-height: 30px !default;
...
$rte-dropdown-transition-color: $white !default;
...
$rte-icon-color: $secondary-text-color-focus !default;
$rte-hover-split-btn-border: 1px solid transparent !default;
$rte-split-btn-border: 1px solid transparent !default;
$rte-button-focus-box-shadow: $secondary-shadow-focus !default;
...
$rte-emoji-pop-border: 1px solid $white;
...
$rte-code-block-label-font-family: Helvetica !default;
...
$rte-quick-toolbar-tip-pointer-border: $content-bg-color !default;
$rte-quick-toolbar-tip-pointer-content: inherit !default;
$rte-quick-popup-filter-color: rgba($black, .15) !default;

$rte-checklist-checked-bg-color: $primary !default;
$rte-checklist-checked-border-color: 1px solid var(--Common-colors-primary, rgba(13, 110, 253, 1)) !default;
$rte-checklist-checked-checkmark-color: $primary-text-color !default;
$rte-checklist-checkbox-border: 1px solid var(--Border-color-border, rgba(222, 226, 230, 1));
...
$rte-big-expended-nav-min-height: 46px;
