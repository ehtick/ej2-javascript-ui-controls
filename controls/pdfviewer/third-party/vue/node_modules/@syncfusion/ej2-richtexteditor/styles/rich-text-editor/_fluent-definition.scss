...
$rte-qt-item-btn-line-height: 40px;
...
$rte-tb-item-active-border: 0 solid $transparent !default;
...
$rte-split-btn-span-hover-bg: $content-bg-color-alt5 !default;
$rte-split-btn-focus-bg: none !default;
$rte-btn-active-bg: $content-bg-color-alt4 !default;
$rte-split-btn-active-color-icon-line-height: 40px !default;
$rte-default-btn-bg: $transparent !default;
$rte-split-btn-border-radius: $inputs-radius !default;
$rte-split-btn-height: 40px !default;
$rte-big-split-btn-height: 48px !default;
$rte-hover-btn-border-color: $icon-color !default;
$rte-active-btn-icons-color: $content-text-color !default;
$rte-default-icon-color: $icon-color !default;
$rte-icon-color: $icon-color !default;
$rte-hover-split-btn-border: 1px solid transparent !default;
$rte-split-btn-border: 1px solid transparent !default;
$rte-button-focus-box-shadow: inset 0 0 0 1px !default;
$rte-dropdown-color: $icon-color !default;
$rte-dropdown-transition-color: $content-text-color !default;
$rte-color-picker-line-height: 1 !default;
$rte-popup-item-min-height: 40px !default;
$rte-big-popup-item-min-height: 48px !default;
...
$rte-content-blockquote-border-left-color: solid 3px $content-bg-color-alt5 !default;
...
$rte-anchor-color: $link-color !default;
...
$rte-table-multicell-select-bg-color: rgba($theme-primary, .1) !default;
...
$rte-quick-popup-outer-margin: 0 8px !default;
$rte-quick-popup-inner-padding: 0 !default;
$rte-quick-big-popup-outer-margin: 0 10px !default;
...
$rte-emoji-pop-box-shadow: 0 4.8px 14.4px rgba(0, 0, 0, .18), 0 25.6px 57.6px rgba(0, 0, 0, .22);
$rte-emoji-pop-border: none;
$rte-emoji-tbar-btn-bg: transparent;
$rte-emoji-tbar-btn-select-bg : $flyout-bg-color-hover;
$rte-emoji-tbar-btn-hover: $flyout-bg-color-hover;
$rte-emoji-btn-height: 248px;
$rte-emoji-grp-btn-height: 40px;
$rte-emoji-grp-btn-width: 40px;
$rte-emoji-headname-font-weight: 400;
$rte-emoji-headname-color: $primary;
...
$rte-quick-toolbar-tip-pointer-border: $flyout-bg-color !default;
$rte-quick-toolbar-tip-pointer-content: inherit !default;
$rte-quick-popup-filter-color: rgba(0, 0, 0, .14) !default;

$rte-popup-padding: 0 8px !default;
$rte-popup-item-padding: 0 0 !default;

$rte-checklist-checked-bg-color: $primary !default;
$rte-checklist-checked-border-color: 1px solid var(--Foreground-color-primary, rgba(0, 120, 212, 1)) !default;
$rte-checklist-checked-checkmark-color: $primary-text-color !default;
$rte-checklist-checkbox-border: 1px solid var(--Border-color-border-alt, rgba(50, 49, 48, 1));

$rte-ai-assistant-btn-disabled: $icon-color-disabled !default;
$rte-ai-assistant-box-shadow: $shadow-xl !default;

$rte-toolbar-item-hov-bg-color: $content-bg-color-alt3;
...
$rte-table-gripper-active-bg: $table-bg-color-selected !default;
$rte-table-gripper-active-color: $icon-color !default;
$rte-table-gripper-hover-bg: $table-bg-color-selected !default;
...
$rte-expended-nav-min-height: 40px;
$rte-big-expended-nav-min-height: 48px;
