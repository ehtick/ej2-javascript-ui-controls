...
$rte-toolbar-icon-size: 18px !default;
...
$rte-table-popup-min-height: 164px !default;
...
$rte-table-popup-border-radius: 2px !default;
...
$rte-split-btn-focus-bg: $content-bg-color-alt1 !default;
$rte-btn-active-bg: $content-bg-color-alt1 !default;
$rte-split-btn-active-color-icon-line-height: 30px !default;
...
$rte-popup-item-min-height: 30px !default;
...
$rte-quick-popup-border: 1px solid $border-light !default;
$rte-quick-popup-border-radius: 2px !default;
$rte-quick-popup-outer-margin: 3px 7px !default;
$rte-quick-popup-inner-padding: 0 4px !default;
$rte-quick-big-popup-outer-margin: 4px 9px !default;
$rte-quick-big-popup-inner-padding: 0 6px !default;
...
$rte-quick-toolbar-tip-pointer-border: $border-light !default;
$rte-quick-toolbar-tip-pointer-content: $content-bg-color-alt2 !default;
...
$rte-checklist-checked-border-color: 1px solid var(--Button-Primary-Button-primary-bg-color, rgba(79, 70, 229, 1)) !default;
$rte-checklist-checked-checkmark-color: $primary-text-color !default;
$rte-checklist-checkbox-border: 1px solid var(--Border-color-border, rgba(209, 213, 219, 1));

$rte-ai-assistant-btn-disabled: $icon-color-disabled !default;
$rte-ai-assistant-box-shadow: $shadow-lg !default;

$rte-toolbar-item-hov-bg-color: $content-bg-color-alt1;
