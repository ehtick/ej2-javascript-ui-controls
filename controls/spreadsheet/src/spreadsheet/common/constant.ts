...
export const defaultLocale: object = {
    ...
    AIAssistHeader: 'AI Assist',
    AIAssistBannerHeader: 'AI Assistance',
    AIAssistBannerContent: 'How can I help you with this sheet?',
    AIAssistInputPlaceHolder: 'Type your prompt for assistance...',
    Hyperlink: 'Hyperlink',
