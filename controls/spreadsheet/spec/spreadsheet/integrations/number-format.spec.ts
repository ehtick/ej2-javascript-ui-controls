...
describe('Spreadsheet Number Format Module ->', (): void => {
    ...
    describe('Custom number format ->', (): void => {
        ...
        it('Automatic custom date format deduction based on cell value checking', (done: Function) => {
            ...
            expect(cells[1].value).toBe('46122');
            ...
            expect(cells[3].value).toBe('46195');
        ...
        it('Custom short date format checking', (done: Function) => {
            ...
            expect(cells[2].value).toBe('46122');
            expect(cellElems[2].textContent).toBe('10-Apr');
    ...
    describe('Culture based number format ->', (): void => {
        ...
        it('EJ2-907514 -> Date formats not working as expected while editing in German cultures', (done: Function) => {
            ...
            expect(spreadsheet.sheets[0].rows[1].cells[8].value).toBe('46047');
            ...
            expect(spreadsheet.sheets[0].rows[1].cells[8].formattedText).toBe('Sonntag, 25. Januar 2026');
            ...
            expect(spreadsheet.sheets[0].rows[1].cells[9].value).toBe('46047');
            ...
            expect(spreadsheet.sheets[0].rows[1].cells[9].formattedText).toBe('25.1.2026');
    ...
    describe('EJ2-894973 ->', () => {
        ...
        it('EJ2-924874 - Data not correctly loaded in imported file', (done: Function) => {
            ...
            expect(helper.getInstance().sheets[0].rows[11].cells[0].value).toBe('-0.6666666666666666');
