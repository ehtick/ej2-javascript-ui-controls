...
export interface DiagramModel extends ComponentModel{
     ...
     *  @event
     */
    diagramImporting?: EmitType<IImportingEventArgs>;
     ...
     *  @event
     */
    diagramExporting?: EmitType<IExportingEventArgs>;
    ...
    // * @event
    // */
    erEntityChanged?: EmitType<IErEntityChangedEventArgs>;
