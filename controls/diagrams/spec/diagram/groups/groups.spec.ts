...
describe('Group', () => {
    ...
    describe('Group With context Menu', () => {
        ...
        it('Ungroup - Internal Group', (done: Function) => {
            ...
            diagram.unGroup();
            expect(diagram.nodes.length).toBe(7);
            expect((diagram.nameTable['group1'] as Node).children.length).toBe(3);
    ...
    describe('Group with annnotation', () => {
        ...
        it('Group With Default along with annotation rotate', (done: Function) => {
            ...
            expect(Math.round(diagram.selectedItems.nodes[0].wrapper.children[2].parentTransform) === 331 || Math.round(diagram.selectedItems.nodes[0].wrapper.children[2].parentTransform) === 332 || Math.ceil(diagram.selectedItems.nodes[0].wrapper.children[2].parentTransform) === 334).toBe(true);
            mouseEvents.clickEvent(diagramCanvas, 10, 10);
