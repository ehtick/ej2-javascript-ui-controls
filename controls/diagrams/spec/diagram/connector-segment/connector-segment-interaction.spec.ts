...
describe('Diagram Control', () => {
    ...
    describe('Conectors with segments - Orthogonal Segment Interaction(Port To Point)', () => {
        ...
        it('Checking Orthogonal segment - Port To Point Interaction (Port direction- Left)', (done: DoneFn): void => {
            ...
            // Initial assertions (exact values are safe here)
            expectPointClose(c0.intermediatePoints[0], 75, 100);
            expectPointClose(c0.intermediatePoints[1], 25, 100);
            expectPointClose(c0.intermediatePoints[2], 25, 200);
            expectPointClose(c0.intermediatePoints[3], 300, 200);

            // ─────────────────────────────
            // Phase A: drag first segment horizontally
            // ─────────────────────────────
            ...
            const cA: any = diagram.selectedItems.connectors[0];
            expectPointClose(cA.intermediatePoints[0], 75, 100, 10);
            expectPointClose(cA.intermediatePoints[1], 50, 100);
            expectPointClose(cA.intermediatePoints[2], cA.intermediatePoints[1].x, 200, 10);
            expectPointClose(cA.intermediatePoints[3], 300, 200);
            ...
            const cB: any = diagram.selectedItems.connectors[0];
            expectPointClose(cB.intermediatePoints[0], 75, 100);
            expectPointClose(cB.intermediatePoints[1], 60, 100,10);
            expectPointClose(cB.intermediatePoints[2], 60, 145,10);
            expectPointClose(cB.intermediatePoints[3], 155, 145,10);
            expectPointClose(cB.intermediatePoints[4], 155, 200,10);
            expectPointClose(cB.intermediatePoints[5], 300, 200,10);
            ...
            const cC: any = diagram.selectedItems.connectors[0];
            expectPointClose(cC.intermediatePoints[0], 75, 100);
            expectPointClose(cC.intermediatePoints[1], 60, 100,10);
            expectPointClose(cC.intermediatePoints[2], 60, 20,10);
            expectPointClose(cC.intermediatePoints[3], 155, 20,10);
            expectPointClose(cC.intermediatePoints[4], 155, 200,10);
            expectPointClose(cC.intermediatePoints[cC.intermediatePoints.length - 1], 300, 200);
            done();
    ...
    describe('Conectors with segments - Orthogonal Segment Interaction(Point To Node)', () => {
        ...
        it('Checking Orthogonal segment - Point To Node Interaction(Target direction-"Bottom To Center")', (done: DoneFn): void => {
            const diagramCanvas = document.getElementById(diagram.element.id + 'content') as HTMLElement;
            const rect :any = diagram.element.getBoundingClientRect();

            diagram.select([diagram.connectors[2]]);
            const c0: any = diagram.selectedItems.connectors[0];

            expectPointClose(c0.intermediatePoints[0], 300, 200);
            expectPointClose(c0.intermediatePoints[1], 300, 150);
            expectPointClose(c0.intermediatePoints[2], 100, 150);
            expectPointClose(c0.intermediatePoints[3], 100, 125);

            // Drag using real rendered segment point (index 1)
            ...
            const cA: any = diagram.selectedItems.connectors[0];
            expectPointClose(cA.intermediatePoints[0], 300, 200);
            expectPointClose(cA.intermediatePoints[1], 300, 108);
            expectPointClose(cA.intermediatePoints[2], 145, 108);
            done();
    ...
    describe('Conectors with segments - Orthogonal Segment interaction(Node To Node)', () => {
        ...
        it('Checking Orthogonal segment - Node to Node(single segment-Left)', (done: DoneFn): void => {
            ...
            let cA: any = diagram.selectedItems.connectors[0];
            expectPointClose(cA.intermediatePoints[0], 375, 300);
            expectPointClose(cA.intermediatePoints[1], 283, 300, 10);
            expectPointClose(cA.intermediatePoints[2], 283, 116, 10);
            expectPointClose(cA.intermediatePoints[3], 145, 116);
            ...
            let cB: any = diagram.selectedItems.connectors[0];
            expectPointClose(cB.intermediatePoints[0], 400, 275);
            expectPointClose(cB.intermediatePoints[2], 380, 255);
            expectPointClose(cB.intermediatePoints[4], 145, 116);
            ...
            let cC: any = diagram.selectedItems.connectors[0];
            expectPointClose(cC.intermediatePoints[2], 100, 255);
            ...
            let cD: any = diagram.selectedItems.connectors[0];
            expectPointClose(cD.intermediatePoints[1], 400, 108);
            
            expectPointClose(cD.intermediatePoints[2], 100, 108, 50);
            ...
            expectPointClose(cD.intermediatePoints[0], 400, 275,10);
            expectPointClose(cD.intermediatePoints[1], 400, 220,10);
            expectPointClose(cD.intermediatePoints[2], 200, 220,20);
            done();
        });
