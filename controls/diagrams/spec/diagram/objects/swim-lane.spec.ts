...
describe('Diagram Control', () => {
    ...
    describe('Swimlane Sample', () => {
        ...
        let diagramCanvas: HTMLElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagramSwimlaneSample' });
            document.body.appendChild(ele);
            ...
            diagram = new Diagram({ width: 1000, height: 1000, nodes: nodes });
            diagram.appendTo('#diagramSwimlaneSample');
            diagramCanvas = document.getElementById(diagram.element.id + 'content');
    ...
    describe('Swimlane - Lane interchange', () => {
        describe('Horizontal swimlane', () => {
            ...
            beforeAll((): void => {
                ...
                ele.appendChild(createElement('div', { id: 'SwimlaneDiagramLane', styles: 'width:74%;height:500px;float:left;' }));
                document.body.appendChild(ele);
                let nodes: NodeModel[] = [
                    {
                        id: 'swimlane',
                ...
                diagram.appendTo('#SwimlaneDiagramLane');
            });
            afterAll((): void => {
                diagram.destroy();
                ele.remove();
    ...
    describe('Swimlane Sample', () => {
        ...
        let diagramCanvas: HTMLElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagramSwimlaneProperty' });
            document.body.appendChild(ele);
            ...
            diagram.appendTo('#diagramSwimlaneProperty');
            diagramCanvas = document.getElementById(diagram.element.id + 'content');
            mouseEvents.clickEvent(diagramCanvas, 10, 10);
        });
        afterAll((): void => {
    ...
    describe('Swimlane Connector interaction', () => {
        describe('Connector Selection issue', () => {
            ...
            beforeAll((): void => {
                ele = createElement('div', { styles: 'width:100%;height:500px;' });
                ele.appendChild(createElement('div', { id: 'symbolpaletteSelection', styles: 'width:25%;float:left;' }));
                ele.appendChild(createElement('div', { id: 'SwimlaneDiagramSelection', styles: 'width:74%;height:500px;float:left;' }));
                document.body.appendChild(ele);
                let pathData = 'M 120 24.9999 C 120 38.8072 109.642 50 96.8653 50 L 23.135' +
                    ' 50 C 10.3578 50 0 38.8072 0 24.9999 L 0 24.9999 C' +
                    '0 11.1928 10.3578 0 23.135 0 L 96.8653 0 C 109.642 0 120 11.1928 120 24.9999 Z';
                ...
                diagram.appendTo('#SwimlaneDiagramSelection');
                ...
                palette.appendTo('#symbolpaletteSelection');
    ...
    describe('Swimlane interaction', () => {
        describe('Horizontal Orientation', () => {
            ...
            beforeAll((): void => {
                ele = createElement('div', { styles: 'width:100%;height:500px;' });
                ele.appendChild(createElement('div', { id: 'symbolpaletteInteraction', styles: 'width:25%;float:left;' }));
                ele.appendChild(createElement('div', { id: 'SwimlaneDiagramInteraction', styles: 'width:74%;height:500px;float:left;' }));
                document.body.appendChild(ele);
                let pathData = 'M 120 24.9999 C 120 38.8072 109.642 50 96.8653 50 L 23.135' +
                    ' 50 C 10.3578 50 0 38.8072 0 24.9999 L 0 24.9999 C' +
                    '0 11.1928 10.3578 0 23.135 0 L 96.8653 0 C 109.642 0 120 11.1928 120 24.9999 Z';
                ...
                diagram.appendTo('#SwimlaneDiagramInteraction');
                ...
                palette.appendTo('#symbolpaletteInteraction');
        ...
        describe('Vertical Orientation', () => {
            ...
            it('Selection - phase', (done: Function) => {
                let phase = diagram.nameTable["swimlanephase1_header"];
                mouseEvents.clickEvent(diagramCanvas, phase.wrapper.offsetX + diagram.element.offsetLeft, phase.wrapper.offsetY + diagram.element.offsetTop);
                expect(diagram.selectedItems.nodes[0].id == 'swimlanephase1_header').toBe(true);
                done();
            });
            ...
            it('Drag and drop the node from palette to lane', (done: Function) => {
                // Wait for palette to fully initialize
                setTimeout(() => {
                    const ele = document.getElementById("Terminator_container");

                    // Add null check before using element
                    if (!ele) {
                        fail('Terminator_container element not found');
                        done();
                        return;
                    }

                    const bounds: DOMRect = ele.getBoundingClientRect() as DOMRect;
                    ...
                    palette.element['ej2_instances'][1]['helper'] = (e: any) => {
                        ...
                        let symbols: IElement = palette.symbolTable['Terminator'];
                        palette['selectedSymbols'] = symbols;
                        console.log('swimlane issue');
                        console.log(palette.element.id);
                        if (symbols !== undefined) {
                            clonedElement = palette['getSymbolPreview'](symbols, e.sender, palette.element);
                            if (clonedElement) {
                                clonedElement.setAttribute('paletteId', palette.element.id);
    ...
    describe('Swimlane - Lane interchange', () => {
        describe('Horizontal swimlane', () => {
            ...
            beforeAll((): void => {
                ele = createElement('div', { styles: 'width:100%;height:500px;' });
                ele.appendChild(createElement('div', { id: 'SwimlaneDiagramLane1', styles: 'width:74%;height:500px;float:left;' }));
                document.body.appendChild(ele);
                ...
                diagram.appendTo('#SwimlaneDiagramLane1');
        ...
        describe('Horizontal swimlane', () => {
            ...
            beforeAll((): void => {
                ele = createElement('div', { styles: 'width:100%;height:500px;' });
                ele.appendChild(createElement('div', { id: 'horizontalSwimlaneDiagram', styles: 'width:74%;height:500px;float:left;' }));
                document.body.appendChild(ele);
                ...
                diagram.appendTo('#horizontalSwimlaneDiagram');
    ...
    describe('853721-Grid lines remain hidden when lane fill is set to transparent.', () => {
        ...
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagramSwimlaneTransparent2' });
            document.body.appendChild(ele);
            let nodes: NodeModel[] = [
                {
                    id: 'swimlane',
            ...
            diagram.appendTo('#diagramSwimlaneTransparent2');
        });
        afterAll((): void => {
            diagram.destroy();
            ele.remove();
    ...
    describe('empty the lane and Check swimlane render or not while passing element container as secondary parameter', () => {
        ...
        let btn: HTMLButtonElement;
        beforeAll((): void => {
            ele = createElement('div', { id: 'diagramSwimlaneTransparent1' });
            document.body.appendChild(ele);
            let nodes: NodeModel[] = [
                {
                    id: 'swimlane',
...
describe('Code coverage Drag and drop horizontal swimlane from palette to diagram with customized lanes and phase', () => {
    ...
    beforeAll((): void => {
        ele = createElement('div', { styles: 'width:100%;height:500px;' });
        ele.appendChild(createElement('div', { id: 'symbolGuidesCover', styles: 'width:25%;float:left;' }));
        ele.appendChild(createElement('div', { id: 'SwimlaneGuidesCover', styles: 'width:74%;height:500px;float:left;' }));
        document.body.appendChild(ele);
        diagram = new Diagram({
            width: '70%',
            height: '800px',
        });
        diagram.appendTo('#SwimlaneGuidesCover');
        palette = new SymbolPalette({
            width: '25%', height: '500px',
            palettes: [
                {
        ...
        palette.appendTo('#symbolGuidesCover');
    });
    afterAll((): void => {
        diagram.destroy();
        ele.remove();
...
describe('code coverage Drag the node from the palette and click escape', () => {
    ...
    beforeAll((): void => {
        ele = createElement('div', { styles: 'width:100%;height:500px;' });
        ele.appendChild(createElement('div', { id: 'symbolpaletteDrag', styles: 'width:25%;float:left;' }));
        ele.appendChild(createElement('div', { id: 'SwimlaneDiagramDrag', styles: 'width:74%;height:500px;float:left;' }));
        document.body.appendChild(ele);
        let pathData = 'M 120 24.9999 C 120 38.8072 109.642 50 96.8653 50 L 23.135' +
            ' 50 C 10.3578 50 0 38.8072 0 24.9999 L 0 24.9999 C' +
            '0 11.1928 10.3578 0 23.135 0 L 96.8653 0 C 109.642 0 120 11.1928 120 24.9999 Z';
        ...
        diagram.appendTo('#SwimlaneDiagramDrag');
        palette = new SymbolPalette({
            width: '25%', height: '500px',
            palettes: [
                {
        ...
        palette.appendTo('#symbolpaletteDrag');
...
describe('882239 - Fill color not applied properly while adding phase at runtime', () => {
    ...
    beforeAll((): void => {
        ele = createElement('div', { styles: 'width:100%;height:500px;' });
        ele.appendChild(createElement('div', { id: 'symbolpaletteFill', styles: 'width:25%;float:left;' }));
        ele.appendChild(createElement('div', { id: 'SwimlaneDiagramFill', styles: 'width:74%;height:500px;float:left;' }));
        document.body.appendChild(ele);
        let pathData = 'M 120 24.9999 C 120 38.8072 109.642 50 96.8653 50 L 23.135' +
            ' 50 C 10.3578 50 0 38.8072 0 24.9999 L 0 24.9999 C' +
            '0 11.1928 10.3578 0 23.135 0 L 96.8653 0 C 109.642 0 120 11.1928 120 24.9999 Z';
        ...
        diagram.appendTo('#SwimlaneDiagramFill');
        ...
        palette.appendTo('#symbolpaletteFill');
...
describe('code coverage Fill color not applied properly while adding phase at runtime ', () => {
    ...
    beforeAll((): void => {
        ele = createElement('div', { styles: 'width:100%;height:500px;' });
        ele.appendChild(createElement('div', { id: 'symbolpaletteFillCover', styles: 'width:25%;float:left;' }));
        ele.appendChild(createElement('div', { id: 'SwimlaneDiagramFillCover', styles: 'width:74%;height:500px;float:left;' }));
        document.body.appendChild(ele);
        let pathData = 'M 120 24.9999 C 120 38.8072 109.642 50 96.8653 50 L 23.135' +
            ' 50 C 10.3578 50 0 38.8072 0 24.9999 L 0 24.9999 C' +
            '0 11.1928 10.3578 0 23.135 0 L 96.8653 0 C 109.642 0 120 11.1928 120 24.9999 Z';
        ...
        diagram.appendTo('#SwimlaneDiagramFillCover');
        ...
        palette.appendTo('#symbolpaletteFillCover');
...
describe('Multi select Swimlane child and drag them', () => {
    let diagram: Diagram;
    let ele: HTMLElement;
    let mouseEvents = new MouseEvents();
    let diagramCanvas: HTMLElement;
    ...
    it('Multi select swimlane child nodes and drag', (done: Function) => {
        let node = diagram.nodes[10];
        diagram.select([diagram.nodes[10], diagram.nodes[11]]);
        let dragnode = document.getElementById('child2_groupElement');
        let bounds1 = dragnode.getBoundingClientRect();
        let x = bounds1.left + bounds1.width / 2;
        let y = bounds1.top + bounds1.height / 2;
