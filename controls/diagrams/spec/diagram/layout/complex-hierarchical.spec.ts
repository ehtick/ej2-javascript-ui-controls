...
describe('Diagram Control', () => {
    describe('Complex Hierarchical Nan issue fix', () => {
        ...
        it('checking the node which have multiple parent', (done: Function) => {
            ...
            let connector1 = diagram.connectors[1].id;
            let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
            ...
            let connector11 = diagram.connectors[11].id;
            let pathElement11 = document.getElementById(connector11 + "_path_groupElement");
            ...
            let connector26 = diagram.connectors[26].id;
            let pathElement26 = document.getElementById(connector26 + "_path_groupElement");
...
describe('Diagram Control', () => {
    describe('Update Datasource without using layout issue fix', () => {
        ...
        it('checking the node which have multiple parent', (done: Function) => {
            ...
            diagram.dataBind();
            let element = document.getElementById('node1111_content_groupElement')
...
describe('Complex Tree Layout', () => {
    ...
    it('CR issue for node and connector collection reset', (done: Function) => {
        ...
        diagram.dataBind();
        expect(diagram.nodes[0].offsetX === 65 && diagram.nodes[0].offsetY === 410 && diagram.nodes.length === 5).toBe(true);
        done();
    });
});
...
xdescribe('Layout nodes and connectors overllaping issues', () => {
    describe('Layout nodes and connectors overllaping issues', () => {
        ...
        let getNodeTemplate = function (obj: NodeModel) {
            // Main Panel
...
describe('DataLoaded event do not gets trigger after data loaded', () => {
    ...
    describe('Overlapping issue', () => {
        ...
        it('nodes and connectors overlap issue', function (done) {
            ...
            expect(((diagram.connectors[8] as Connector).intermediatePoints[2].x == 310 || (diagram.connectors[8] as Connector).intermediatePoints[2].x == 350) && (diagram.connectors[8] as Connector).intermediatePoints[2].y == 300).toBe(true);
            expect((diagram.connectors[8] as Connector).intermediatePoints[3].x == 410 && (diagram.connectors[8] as Connector).intermediatePoints[3].y == 300).toBe(true);
            done();
        });
    ...
    describe('Tree Line Distribution 2', () => {
        ...
        it('Tree Line Distribution 2r data loaded', function (done) {
            ...
            let connector25 = diagram.connectors[25].id
            let pathElement25 = document.getElementById(connector25 + "_path_groupElement")
        ...
        it('Tree Line Distribution 2 change RighToLeft', function (done) {
            ...
            let connector0 = diagram.connectors[0].id;
            let pathElement = document.getElementById(connector0 + "_path_groupElement");
            console.log("path :", pathElement.children[0].getAttribute("d"))
            expect(pathElement.children[0].getAttribute("d") === "M40,0 L27,0 Q20,0,20,7 L20,63 Q20,70,13,70 L0.5,70 ").toBe(true);

            let connector1 = diagram.connectors[1].id;
            let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
            console.log("path1 :", pathElement1.children[0].getAttribute("d"))
            ...
            let connector11 = diagram.connectors[11].id;
            let pathElement11 = document.getElementById(connector11 + "_path_groupElement");
            console.log("path11 :", pathElement11.children[0].getAttribute("d"))
            ...
            let connector25 = diagram.connectors[25].id;
            let pathElement25 = document.getElementById(connector25 + "_path_groupElement");
            console.log("path25 :", pathElement25.children[0].getAttribute("d"))
        ...
        it('Tree Line Distribution 2 change RighToLeft', function (done) {
            ...
            let child1elemeent = document.getElementById(diagram.nodes[0].id + "_groupElement")
            console.log("x ",child1elemeent.children[0].getAttribute("x"))
            expect(child1elemeent.children[0].getAttribute("x") === '400').toBe(true);
            console.log("y ",child1elemeent.children[0].getAttribute("y"))
            expect(child1elemeent.children[0].getAttribute("y") === '160').toBe(true);
            console.log(child1elemeent.children[0].getAttribute("transform"))
            expect(child1elemeent.children[0].getAttribute("transform") === 'rotate(0,420,180)').toBe(true);
            diagram.layout.connectionPointOrigin = ConnectionPointOrigin.SamePoint;
            diagram.dataBind()

            let child1elemeent1 = document.getElementById(diagram.nodes[0].id + "_groupElement")
            console.log(child1elemeent.children[0].getAttribute("x"))
            expect(child1elemeent1.children[0].getAttribute("x") === '400').toBe(true);
            console.log(child1elemeent.children[0].getAttribute("y"))
            expect(child1elemeent1.children[0].getAttribute("y") === '160').toBe(true);
            console.log(child1elemeent.children[0].getAttribute("transform"))
            expect(child1elemeent1.children[0].getAttribute("transform") === 'rotate(0,420,180)').toBe(true);
    ...
    describe('Tree Line Distribution 3', () => {
        ...
        //     diagram1.dataBind();
        //     let connector0 = diagram1.connectors[0].id;
        //     let pathElement = document.getElementById(connector0 + "_path_groupElement");
        //     console.log("Tree Line Distribution 3 change RighToLeft- pathElement: ", pathElement.children[0].getAttribute("d"))
        ...
        //     let connector1 = diagram1.connectors[1].id;
        //     let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
        //     console.log("Tree Line Distribution 3 change RighToLeft- pathElement1: ", pathElement1.children[0].getAttribute("d"))
        //     expect(pathElement1.children[0].getAttribute("d") === "M70,101.9 L66.39,101.9 Q62.77,101.9,62.77,96.9 L62.77,5 Q62.77,0,57.77,0 L36.39,0 Q31.39,0,31.39,0 Q31.39,0,26.39,0 L0,0 " || pathElement1.children[0].getAttribute("d") === "M70,101.9 L40,101.9 Q35,101.9,35,96.9 L35,5 Q35,0,30,0 L0,0 ").toBe(true);

        //     let connector25 = diagram1.connectors[25].id;
        //     let pathElement25 = document.getElementById(connector25 + "_path_groupElement");
        //     console.log("Tree Line Distribution 3 change RighToLeft- pathElement25: ", pathElement25.children[0].getAttribute("d"))
        //     expect(pathElement25.children[0].getAttribute("d") === "70,0 L40,0 Q35,0,35,0 Q35,0,30,0 L0,0 " || pathElement25.children[0].getAttribute("d") === "M70,0 L0,0 ").toBe(true);
        //     done();
        // });
    ...
    describe('Tree Line Distribution 1', () => {
        ...
        it('Tree Line Distribution 1 loaded', function (done) {
            ...
            let connector0 = diagram.connectors[0].id;
            let pathElement = document.getElementById(connector0 + "_path_groupElement");
            console.log("Tree Line Distribution 1-pathElement: ",pathElement.children[0].getAttribute("d"));
            expect(pathElement.children[0].getAttribute("d") === "M181.99,0 L181.99,9 L0,9 L0,19.5 L0,19.5 L-0.19,29.1 " || pathElement.children[0].getAttribute("d") === "M187,0 L187,15 L0,15 L-0.05,29.1 " || pathElement.children[0].getAttribute("d") === 'M182.32,0 L182.32,9 L0,9 L0,19.5 L0,19.5 L0.42,29.1 ' || pathElement.children[0].getAttribute("d") === 'M181.99,0 L181.99,9 L0,9 L0,19.5 L0,19.5 L-0.06,29.1 '
                || pathElement.children[0].getAttribute("d") === 'M181.99,0 L181.99,9 L0,9 L0,19.5 L0,19.5 L-0.37,29.1 ').toBe(true);
            let connector1 = diagram.connectors[1].id;
            let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
            console.log("Tree Line Distribution 1-pathElement1: ",pathElement1.children[0].getAttribute("d"));
            expect(pathElement1.children[0].getAttribute("d") === "M0,0 L0,15 L0,15 L-0.19,29.7 " || pathElement1.children[0].getAttribute("d") === "M0,0 L-0.05,29.7 " || pathElement1.children[0].getAttribute("d") === 'M0,0 L0,15 L0,15 L0.43,29.7 ' || pathElement1.children[0].getAttribute("d") === 'M0,0 L0,15 L0,15 L-0.06,29.7 '
                || pathElement1.children[0].getAttribute("d") === 'M0,0 L0,15 L0,15 L-0.38,29.7 ').toBe(true);
            let connector11 = diagram.connectors[11].id;
            let pathElement11 = document.getElementById(connector11 + "_path_groupElement");
            console.log("Tree Line Distribution 1-pathElement11: ",pathElement11.children[0].getAttribute("d"));
            expect(pathElement11.children[0].getAttribute("d") === "M0,0 L0,15 L38.34,15 L38.34,22.5 L38.34,22.5 L37.89,29.1 " || pathElement11.children[0].getAttribute("d") === "M0,0 L0,15 L39.45,15 L39.76,29.1 " || pathElement11.children[0].getAttribute("d") === 'M0,0 L0,15 L38.34,15 L38.34,22.5 L38.34,22.5 L38.34,29.1 '
        ...
        it('Tree Line Distribution 1 BottomToTop', function (done) {
            ...
            let connector0 = diagram.connectors[0].id;
            let pathElement = document.getElementById(connector0 + "_path_groupElement");
            console.log("Tree Line Distribution 1 BottomToTop-pathElement: ", pathElement.children[0].getAttribute("d"));
            expect(pathElement.children[0].getAttribute("d") === "M181.99,30 L181.99,21 L0,21 L0,10.5 L0,10.5 L-0.19,0.3 " || pathElement.children[0].getAttribute("d") === "M187,30 L187,15 L0,15 L-0.05,0.3 ").toBe(true);
            let connector1 = diagram.connectors[1].id;
            let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
            console.log("Tree Line Distribution 1 BottomToTop-pathElement: ", pathElement1.children[0].getAttribute("d"));
            expect(pathElement1.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L-0.19,0.7 " || pathElement1.children[0].getAttribute("d") === "M0,30 L-0.05,0.7 ").toBe(true);
            let connector11 = diagram.connectors[11].id;
            let pathElement11 = document.getElementById(connector11 + "_path_groupElement");
            console.log("Tree Line Distribution 1 BottomToTop-pathElement: ", pathElement11.children[0].getAttribute("d"));
            expect(pathElement11.children[0].getAttribute("d") === "M0,30 L0,15 L38.34,15 L38.34,7.5 L38.34,7.5 L37.89,0.3 " || pathElement11.children[0].getAttribute("d") === "M0,30 L0,15 L39.45,15 L39.76,0.3 ").toBe(true);
        ...
        it('Tree Line Distribution 1 data source change', function (done) {
            ...
            let connector0 = diagram.connectors[0].id;
            let pathElement = document.getElementById(connector0 + "_path_groupElement");
            console.log("1 data source change-pathElement ",pathElement.children[0].getAttribute("d"));
            expect(pathElement.children[0].getAttribute("d") === "M181.99,30 L181.99,21 L0,21 L0,10.5 L0,10.5 L-0.19,0.3 " || pathElement.children[0].getAttribute("d") === "M187,30 L187,15 L0,15 L0.31,0.3 ").toBe(true);
            let connector1 = diagram.connectors[1].id;
            let pathElement1 = document.getElementById(connector1 + "_path_groupElement");
            console.log("1 data source change-pathElement1 ",pathElement1.children[0].getAttribute("d"));
            expect(pathElement1.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L-0.19,0.7 " || pathElement1.children[0].getAttribute("d") === "M0,30 L0.31,0.7 ").toBe(true);
            let connector11 = diagram.connectors[11].id;
            let pathElement11 = document.getElementById(connector11 + "_path_groupElement");
            console.log("1 data source change-pathElement11 ",pathElement11.children[0].getAttribute("d"));
            expect(pathElement11.children[0].getAttribute("d") === "M0,30 L0,15 L38.34,15 L38.34,7.5 L38.34,7.5 L37.89,0.3 " || pathElement11.children[0].getAttribute("d") === "M0,30 L0,15 L39.45,15 L39.15,0.3 ").toBe(true);


            let connector26 = diagram.connectors[26].id;
            let pathElement26 = document.getElementById(connector26 + "_path_groupElement");
            console.log("1 data source change-pathElement26 ",pathElement26.children[0].getAttribute("d"));
            expect(pathElement26.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L0.14,0.5 " || pathElement26.children[0].getAttribute("d") === "M0,30 L-0.04,0.5 ").toBe(true);

            let connector27 = diagram.connectors[27].id;
            let pathElement27 = document.getElementById(connector27 + "_path_groupElement");
            console.log(pathElement27.children[0].getAttribute("d"));
            expect(pathElement27.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L0.14,0.9 " || pathElement27.children[0].getAttribute("d") === "M0,30 L-0.04,0.9 ").toBe(true);
            done();
        });
        it('Tree Line Distribution 1 after avoid overlapping boolean set to false', function (done) {
            
            const connector0Id = diagram.connectors[0].id;
            ...
            const connector1Id = diagram.connectors[1].id;
            const pathEl1 = document.getElementById(connector1Id + "_path_groupElement");
            console.log("pathEl1 ",pathEl1.children[0].getAttribute("d"));
            expect(
                pathEl1.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L-0.19,0.7 " ||
                pathEl1.children[0].getAttribute("d") === "M0,30 L0.31,0.7 "
            ).toBe(true);

            const connector11Id = diagram.connectors[11].id;
            const pathEl11 = document.getElementById(connector11Id + "_path_groupElement");
            console.log("pathEl11 ",pathEl11.children[0].getAttribute("d"));
            expect(
                pathEl11.children[0].getAttribute("d") === "M0,30 L0,15 L38.34,15 L38.34,7.5 L38.34,7.5 L37.89,0.3 " ||
                pathEl11.children[0].getAttribute("d") === "M0,30 L0,15 L39.45,15 L39.15,0.3 "
            ).toBe(true);

            const connector26Id = diagram.connectors[26].id;
            ...
            const connector0IdAfter = diagram.connectors[0].id;
            const pathEl0After = document.getElementById(connector0IdAfter + "_path_groupElement");
            console.log("pathEl0 ",pathEl0After.children[0].getAttribute("d"));
            expect(
                pathEl0After.children[0].getAttribute("d") === "M199.66,30 L199.66,15 L0,15 L-0.19,0.3 "
            ).toBe(true);

            const connector1IdAfter = diagram.connectors[1].id;
            ...
            const pathEl11After = document.getElementById(connector11IdAfter + "_path_groupElement");
            console.log("pathEl11 ",pathEl11After.children[0].getAttribute("d"));
            expect(
                pathEl11After.children[0].getAttribute("d") === "M0,30 L0,15 L60.68,15 L60.22,0.3 "
            ).toBe(true);

            const connector26IdAfter = diagram.connectors[26].id;
            const pathEl26After = document.getElementById(connector26IdAfter + "_path_groupElement");
            console.log("pathEl26 ",pathEl26After.children[0].getAttribute("d"));
            expect(
                pathEl26After.children[0].getAttribute("d") === "M0,30 L0,15 L0,15 L0.14,0.5 "
            ).toBe(true);

            const connector27IdAfter = diagram.connectors[27].id;
            const pathEl27After = document.getElementById(connector27IdAfter + "_path_groupElement");
            console.log("pathE27 ",pathEl27After.children[0].getAttribute("d"));
            expect(
                pathEl27After.children[0].getAttribute("d") === "M0,30 L0.14,0.9 "
            ).toBe(true);
    ...
    describe('Line routing test case 1', () => {
        ...
        beforeAll(() => {
            let node1 = { id: 'n1', width: 70, height: 70, annotations: [{ content: 'node1' }] };
            let node2 = { id: 'n2', width: 70, height: 70, annotations: [{ content: 'node2' }] };
            let node3 = { id: 'n3', width: 70, height: 70, annotations: [{ content: 'node3' }] };
            let node4 = { id: 'n4', width: 70, height: 70, annotations: [{ content: 'node4' }] };
            let node5 = { id: 'n5', width: 70, height: 70, annotations: [{ content: 'node5' }] };
            let node6 = { id: 'n6', width: 70, height: 70, annotations: [{ content: 'node6' }] };// newly added
            let node7 = { id: 'n7', width: 70, height: 70, annotations: [{ content: 'node7' }] };// newly added
            let node8 = { id: 'n8', width: 70, height: 70, annotations: [{ content: 'node8' }] };// newly added
            let node9 = { id: 'n9', width: 70, height: 70, annotations: [{ content: 'node9' }] };// newly added
            let node10 = { id: 'n10', width: 70, height: 70, annotations: [{ content: 'node10' }] };// newly added
            let node11 = { id: 'n11', width: 70, height: 70, annotations: [{ content: 'node11' }] };// newly added
            let node12 = { id: 'n12', width: 70, height: 70, annotations: [{ content: 'node12' }] };// newly added
            // let node13 = { id: 'n13', width: 70, height: 70, annotations: [{ content: 'node13' }] };// newly added
            let connector1 = { id: 'connector1', sourceID: 'n1', targetID: 'n2' };
            let connector2 = { id: 'connector2', sourceID: 'n1', targetID: 'n3' };
            let connector3 = { id: 'connector3', sourceID: 'n2', targetID: 'n4' };
            let connector4 = { id: 'connector4', sourceID: 'n4', targetID: 'n1' };
            let connector5 = { id: 'connector5', sourceID: 'n1', targetID: 'n5' };
            let connector6 = { id: 'connector6', sourceID: 'n1', targetID: 'n6' };
            let connector7 = { id: 'connector7', sourceID: 'n6', targetID: 'n7' };
            let connector8 = { id: 'connector8', sourceID: 'n6', targetID: 'n8' };
            let connector9 = { id: 'connector9', sourceID: 'n6', targetID: 'n9' };
            let connector10 = { id: 'connector10', sourceID: 'n6', targetID: 'n10' };
            let connector11 = { id: 'connector11', sourceID: 'n4', targetID: 'n11' };
            let connector12 = { id: 'connector12', sourceID: 'n9', targetID: 'n12' };
            let connector13 = { id: 'connector13', sourceID: 'n7', targetID: 'n1' };
            let connector14 = { id: 'connector14', sourceID: 'n12', targetID: 'n6' };
        ...
        it('Line routing test case 1', function (done) {
            ...
            let connectorpath6 = document.getElementById("connector6_path_groupElement") as HTMLElement;
            console.log("Line routing test case 1- connectorpath6 ", connectorpath6.children[0].getAttribute("d"));
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M0,290 L0,306 L373.5,306 L373.5,0 L169.5,0 L169.5,15.5 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M0,294 L0,314 L34,314 L34,0 L148.5,0 L148.5,19.5 "
            ).toBe(true);

            let connectorpath4 = document.getElementById("connector4_path_groupElement") as HTMLElement;
            console.log("check test case path4");
            console.log("Line routing test case 1 - connectorpath4 ", connectorpath4.children[0].getAttribute("d"));
            expect(
                connectorpath4.children[0].getAttribute("d") ===
                "M0,290 L0,306 L271.5,306 L271.5,0 L118.5,0 L118.98,15.5 " ||
                connectorpath4.children[0].getAttribute("d") ===
                "M60.58,294 L60.58,314 L0,314 L0,0 L43.33,0 L43.5,19.5 "
            ).toBe(true);

            // Re-check without redeclaration
            connectorpath6 = document.getElementById("connector6_path_groupElement") as HTMLElement;
            connectorpath4 = document.getElementById("connector4_path_groupElement") as HTMLElement;
            console.log("Line routing test case 1 - connectorpath6 ", connectorpath6.children[0].getAttribute("d"));
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M0,290 L0,306 L373.5,306 L373.5,0 L169.5,0 L169.5,15.5 " ||
            ...
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M0,16 L0,0 L373.5,0 L373.5,306 L169.5,306 L169.5,290.5 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M0,20 L0,0 L34,0 L34,314 L148.5,314 L148.5,294.5 "
            ).toBe(true);
            console.log("check test case path4 three");
            console.log("Line routing test case 1- connectorpath4 ", connectorpath4.children[0].getAttribute("d"));
            expect(
                connectorpath4.children[0].getAttribute("d") ===
                'M0,16 L0,0 L271.5,0 L271.5,306 L118.5,306 L118.98,290.5 ' ||
                connectorpath4.children[0].getAttribute("d") ===
                "M0,9 L0,0 L265.42,0 L265.42,306 L6.09,306 L6.09,291 L6.09,291 L6.09,287 L6.09,287 L5.94,283.5 " ||
                connectorpath4.children[0].getAttribute("d") ===
                "M0,20 L0,0 L66.67,0 L66.67,314 L6.09,314 L5.92,294.5 "
            ).toBe(true);
            ...
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M290,0 L306,0 L306,373.5 L0,373.5 L0,169.5 L15.5,169.74 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M294,0 L314,0 L314,34 L0,34 L0,148.5 L19.5,148.74 "
            ).toBe(true);
            console.log("check test case path4 four");
            console.log("Line routing test case 1- connectorpath4 ", connectorpath4.children[0].getAttribute("d"));
            expect(
                connectorpath4.children[0].getAttribute("d") ===
                'M290,0 L306,0 L306,271.5 L0,271.5 L0,118.5 L15.5,118.26 ' ||
                connectorpath4.children[0].getAttribute("d") ===
                "M294,60.58 L314,60.58 L314,0 L0,0 L0,43.33 L19.5,43.74 "
            ).toBe(true);
            ...
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M16,0 L0,0 L0,373.5 L306,373.5 L306,169.5 L290.5,169.74 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M20,0 L0,0 L0,34 L314,34 L314,148.5 L294.5,148.74 "
            ).toBe(true);
            console.log("check test case path4 five");
            console.log("Line routing test case 1- connectorpath4 ", connectorpath4.children[0].getAttribute("d"));
            expect(
                connectorpath4.children[0].getAttribute("d") ===
                'M16,0 L0,0 L0,271.5 L306,271.5 L306,118.5 L290.5,118.26 ' ||
                connectorpath4.children[0].getAttribute("d") ===
                "M9,0 L0,0 L0,246.42 L306,246.42 L306,6.09 L291,6.09 L291,6.09 L287,6.09 L287,6.09 L283.5,6.16 " ||
                connectorpath4.children[0].getAttribute("d") ===
                "M20,0 L0,0 L0,66.67 L314,66.67 L314,6.09 L294.5,6.17 "
            ).toBe(true);
            ...
            connectorpath6 = document.getElementById("connector6_path_groupElement") as HTMLElement;
            connectorpath4 = document.getElementById("connector4_path_groupElement") as HTMLElement;
            console.log("Line routing test case 1-connectorpath6//code added" + connectorpath6.children[0].getAttribute("d")); //code added

            // Expectations commented out in original snippet remain commented
            ...
            expect(
                connectorpath6.children[0].getAttribute("d") ===
                "M40,0 L0,0 L0,565.5 L450,565.5 L450,265.5 L410.5,265.75 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M40,0 L0,0 L0,549 L450,549 L450,244.5 L410.5,244.75 " ||
                connectorpath6.children[0].getAttribute("d") ===
                "M20,0 L0,0 L0,34 L410,34 L410,244.5 L390.5,244.74 "
            ).toBe(true);
            ...
            expect(
                connectorpath4.children[0].getAttribute("d") ===
                'M40,0 L0,0 L0,414.42 L450,414.42 L450,6.09 L430,6.09 L430,6.09 L410.5,6.17 ' ||
                connectorpath4.children[0].getAttribute("d") ===
                "M9,0 L0,0 L0,414.42 L419,414.42 L419,6.09 L399,6.09 L399,6.09 L389,6.09 L389,6.09 L379.5,6.17 " ||
                connectorpath4.children[0].getAttribute("d") ===
                "M40,0 L0,0 L0,415.5 L450,415.5 L450,190.5 L410.5,190.25 "
            ).toBe(true);
    ...
    describe('Line routing test case 2', () => {
        ...
        //     
        //     let id19 = diagram.connectors[19].id;
        //     let connectorpath6 = document.getElementById(id19 + "_path_groupElement") as HTMLElement;

        //     let id20 = diagram.connectors[20].id;
        //     let connectorpath4 = document.getElementById(id20 + "_path_groupElement") as HTMLElement;

        //     console.log("Line routing test case 2//code added connectorpath6" + connectorpath6.children[0].getAttribute("d"));
        //     console.log("Line routing test case 2//code added connectorpath6" + connectorpath4.children[0].getAttribute("d"));

        //     expect(
        //         connectorpath6.children[0].getAttribute("d") ===
        //         'M617.5,0 L617.5,9 Q617.5,16,610.5,16 L291,16 Q284,16,284,23 L284,86 Q284,93,277,93 L7,93 Q0,93,0.22,100 L0.48,108.5 ' ||
        //         connectorpath6.children[0].getAttribute("d") ===
        //         "M575,0 L575,47.5 Q575,54.5,568,54.5 L7,54.5 Q0,54.5,0,61.5 L0,108.5 "
        //     ).toBe(true);
        //     expect(
        //         connectorpath4.children[0].getAttribute("d") ===
        //         'M671,0 L671,9 Q671,16,664,16 L558.5,16 Q551.5,16,551.5,23 L551.5,163 Q551.5,170,544.5,170 L7,170 Q0,170,0,177 L0,185.5 ' ||
        //         connectorpath4.children[0].getAttribute("d") ===
        //         "M636,0 L636,86 Q636,93,629,93 L7,93 Q0,93,0.04,100 L0.5,185.5 "
        //     ).toBe(true);

        //     // Re-fetch without redeclaration
        //     id19 = diagram.connectors[19].id;
        //     connectorpath6 = document.getElementById(id19 + "_path_groupElement") as HTMLElement;
        //     id20 = diagram.connectors[20].id;
        //     connectorpath4 = document.getElementById(id20 + "_path_groupElement") as HTMLElement;

        //     console.log("Line routing test case 2//connectorpath6 code added" + connectorpath6.children[0].getAttribute("d")); //code added
        //     console.log("Line routing test case 2//connectorpath4 code added" + connectorpath4.children[0].getAttribute("d"));
        ...
        //     console.log("Line routing test case 2 //code added connectorpath6" + connectorpath6.children[0].getAttribute("d")); //code added
        //     console.log("Line routing test case 2 //code added connectorpath4" + connectorpath4.children[0].getAttribute("d"));
        ...
        //     expect(
        //         connectorpath6.children[0].getAttribute("d") ===
        //         'M617.5,109 L617.5,100 Q617.5,93,610.5,93 L291,93 Q284,93,284,86 L284,23 Q284,16,277,16 L7,16 Q0,16,0.22,9 L0.48,0.5 ' ||
        //         connectorpath6.children[0].getAttribute("d") ===
        //         "M575,109 L575,61.5 Q575,54.5,568,54.5 L7,54.5 Q0,54.5,0,47.5 L0,0.5 "
        //     ).toBe(true);
        //     expect(
        //         connectorpath4.children[0].getAttribute("d") ===
        //         'M671,186 L671,177 Q671,170,664,170 L558.5,170 Q551.5,170,551.5,163 L551.5,23 Q551.5,16,544.5,16 L7,16 Q0,16,0,9 L0,0.5 ' ||
        //         connectorpath4.children[0].getAttribute("d") ===
        //         "M636,186 L636,100 Q636,93,629,93 L7,93 Q0,93,0.04,86 L0.5,0.5 "
        //     ).toBe(true);
        ...
        //     expect(
        //         connectorpath6.children[0].getAttribute("d") ===
        //         'M0,467.5 L9,467.5 Q16,467.5,16,460.5 L16,216 Q16,209,23,209 L116,209 Q123,209,123,202 L123,7 Q123,0,130,0.22 L138.5,0.48 ' ||
        //         connectorpath6.children[0].getAttribute("d") ===
        //         "M0,442 L62.5,442 Q69.5,442,69.5,435 L69.5,7 Q69.5,0,76.5,0 L138.5,0 "
        //     ).toBe(true);
        //     expect(
        //         connectorpath4.children[0].getAttribute("d") ===
        //         'M0,506 L9,506 Q16,506,16,499 L16,408.5 Q16,401.5,23,401.5 L223,401.5 Q230,401.5,230,394.5 L230,7 Q230,0,237,0 L245.5,0 ' ||
        //         connectorpath4.children[0].getAttribute("d") ===
        //         "M0,485 L116,485 Q123,485,123,478 L123,7 Q123,0,130,0.03 L245.5,0.5 "
        //     ).toBe(true);
        ...
        //     expect(
        //         connectorpath6.children[0].getAttribute("d") ===
        //         'M139,467.5 L130,467.5 Q123,467.5,123,460.5 L123,216 Q123,209,116,209 L23,209 Q16,209,16,202 L16,7 Q16,0,9,0.22 L0.5,0.48 ' ||
        //         connectorpath6.children[0].getAttribute("d") ===
        //         "M139,442 L76.5,442 Q69.5,442,69.5,435 L69.5,7 Q69.5,0,62.5,0 L0.5,0 "
        //     ).toBe(true);
        //     expect(
        //         connectorpath4.children[0].getAttribute("d") ===
        //         'M246,506 L237,506 Q230,506,230,499 L230,408.5 Q230,401.5,223,401.5 L23,401.5 Q16,401.5,16,394.5 L16,7 Q16,0,9,0 L0.5,0 ' ||
        //         connectorpath4.children[0].getAttribute("d") ===
        //         "M246,485 L130,485 Q123,485,123,478 L123,7 Q123,0,116,0.03 L0.5,0.5 "
        //     ).toBe(true);
    ...
    describe('Line routing test case 3', () => {
        ...
        //     let id41 = diagram.connectors[41].id;
        //     let connectorPath6 = document.getElementById(id41 + "_path_groupElement") as HTMLElement;
        //     let id50 = diagram.connectors[50].id;
        //     let connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("1 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M503.5,190 L503.5,15 L0,15 L0,0.5 "
        //     ).toBe(true);
        //     console.log("2 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M0,0 L0,15 L0,15 L0,175 L72.75,175 L72.51,189.5 "
        //     ).toBe(true);

        //     // Re-fetch without redeclaration
        //     id41 = diagram.connectors[41].id;
        //     connectorPath6 = document.getElementById(id41 + "_path_groupElement") as HTMLElement;
        //     id50 = diagram.connectors[50].id;
        //     connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("3 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M503.5,0 L503.5,15 L503.5,15 L503.5,175 L0,175 L0,189.5 "
        //     ).toBe(true);
        //     console.log("4 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M503.5,0 L503.5,15 L503.5,15 L503.5,175 L0,175 L0,189.5 "
        //     ).toBe(true);
        ...
        //     id50 = diagram.connectors[50].id;
        //     connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("5 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "'M503.5,190 L503.5,15 L0,15 L0,0.5 "
        //     ).toBe(true);
        //     console.log(connectorPath4.children[0].getAttribute("d"));
        //     console.log("6 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M0,190 L0,15 L72.75,15 L72.51,0.5 "
        //     ).toBe(true);
        ...
        //     id50 = diagram.connectors[50].id;
        //     connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("7 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M0,471 L17.5,471 L17.5,471 L187.5,471 L187.5,0 L204.5,0 "
        //     ).toBe(true);
        //     console.log("8 connectorPath4 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M0,0 L15,0 L15,1330 L185.75,1330 L185.75,55.25 L204.5,55.49 "
        //     ).toBe(true);
        ...
        //     id50 = diagram.connectors[50].id;
        //     connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("9 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M205,462.67 L190,462.67 L190,1925.67 L23.5,1925.67 L23.5,0 L7.5,0 L7.5,0 L3.75,0 L3.75,0 L0.5,-0.29 "
        //     ).toBe(true); console.log(connectorPath4.children[0].getAttribute("d"));
        //     console.log("10 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M0,471 L17.5,471 L17.5,471 L187.5,471 L187.5,0 L204.5,0 "
        //     ).toBe(true);
        ...
        //     id50 = diagram.connectors[50].id;
        //     connectorPath4 = document.getElementById(id50 + "_path_groupElement") as HTMLElement;
        //     console.log("11 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M205,471 L187.5,471 L187.5,471 L17.5,471 L17.5,0 L0.5,0 "
        //     ).toBe(true); console.log(connectorPath4.children[0].getAttribute("d"));
        //     console.log("12 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M205,0 L187.5,0 L187.5,0 L17.5,0 L17.5,67.75 L0.5,67.51 "
        //     ).toBe(true);
        ...
        //     console.log("13 connectorPath6 ", connectorPath6.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath6.children[0].getAttribute("d") ===
        //         "M340,796 L300,796 L300,796 L40,796 L40,0 L0.5,0 "
        //     ).toBe(true); console.log(connectorPath4.children[0].getAttribute("d"));
        //     console.log("14 connectorPath4 ", connectorPath4.children[0].getAttribute("d"));
        //     expect(
        //         connectorPath4.children[0].getAttribute("d") ===
        //         "M340,0 L300,0 L300,0 L40,0 L40,117.75 L0.5,117.5 "
        //     ).toBe(true);
