...
describe('Diagram Control', () => {
    describe('Tree Layout', () => {
        ...
        it('Checking multiple roots', (done: Function) => {
            ...
            console.log('BoundsY - '+ bounds.y);
            console.log('BoundsWidth - '+ bounds.width);
            console.log('BoundsHeight - '+ bounds.height);
            console.log('OffsetX '+ diagram.nodes[0].offsetX);
            console.log('OffsetY '+ diagram.nodes[0].offsetY);
            expect(bounds.x == 120 && bounds.y == 185 && bounds.width == 960 && bounds.height == 210).toBe(true);
            expect(diagram.nodes[0].offsetX == 375 && diagram.nodes[0].offsetY == 210).toBe(true);
            done();
        });
        it('Checking multiple roots - bottom to top', (done: Function) => {
            ...
            console.log('OffsetY '+ diagram.nodes[0].offsetY);
            expect(bounds.x == 120 && bounds.y == 185 && bounds.width == 960 && bounds.height == 210).toBe(true);
            expect(diagram.nodes[0].offsetX == 375 && diagram.nodes[0].offsetY == 370).toBe(true);
            done();
        });
        it('Checking multiple roots - left to right', (done: Function) => {
            ...
            console.log('OffsetX '+ diagram.nodes[0].offsetX);
            console.log('OffsetY '+ diagram.nodes[0].offsetY);
            expect(bounds.x == 345 && bounds.y == 85 && bounds.width == 510 && bounds.height == 410).toBe(true);
            expect(diagram.nodes[0].offsetX == 420 && diagram.nodes[0].offsetY == 190).toBe(true);
            done();
        });
        it('Checking multiple roots - right to left', (done: Function) => {
            ...
            console.log('OffsetY '+ diagram.nodes[0].offsetY);
            expect(bounds.x == 345 && bounds.y == 85 && bounds.width == 510 && bounds.height == 410).toBe(true);
            expect(diagram.nodes[0].offsetX == 780 && diagram.nodes[0].offsetY == 190).toBe(true);
            done();
        });
