...
describe('Diagram Control', () => {
    describe('Tree Layout', () => {
        ...
        it('With default Branch and without root', (done: Function) => {
            ...
            expect((bounds.x == -524 || bounds.x == -491 || bounds.x == -340 || bounds.x === -552 || bounds.x === -520 || bounds.x === -524) &&
                (bounds.y == 155 || bounds.y == 160 || bounds.y == 130 || bounds.y == 110) &&
                (bounds.width == 1398 || bounds.width == 1090 || bounds.width == 1451 || bounds.width === 1406 || bounds.width == 1399) &&
                (bounds.height == 375 || bounds.height == 490 || bounds.height == 360 || bounds.height == 510)).toBe(true);
        ...
        it('Checking left  layout', (done: Function) => {
            ...
            expect((bounds.x == 290 || bounds.x == 300 || bounds.x == 290) && (bounds.y == 108 || bounds.y == 70 || bounds.y == 50) && (bounds.width == 884 || bounds.width == 690 || bounds.width === 914 ||
                bounds.width == 690 || bounds.width === 880) && (bounds.height == 412 || bounds.height == 490 || bounds.height == 510)).toBe(true);
        ...
        it('Checking Right Layout', (done: Function) => {
            ...
            let bounds: Rect = diagram.spatialSearch.getPageBounds();
            expect((bounds.x == -523 || bounds.x == -519 || bounds.x == -340) && (bounds.y == 101 || bounds.y == 108 || bounds.y == 70 || bounds.y ==  50)
                    && (bounds.width == 853 || bounds.width == 849 || bounds.width == 878 || bounds.width == 882 || bounds.width == 670 ||bounds.width == 690 || bounds.width == 853) &&
                    (bounds.height == 429 || bounds.height == 412 || bounds.height == 490 || bounds.height == 510)).toBe(true);
        ...
        it('Checking with horizontal spacing', (done: Function) => {
            ...
            diagram.dataBind();
            let bounds: Rect = diagram.spatialSearch.getPageBounds();
            expect((bounds.x == 320||bounds.x == 300 || bounds.x == 451 || bounds.x == 536) && (bounds.y == 108 || bounds.y == 70 || bounds.y == 50) &&
                    (bounds.width == 769 || bounds.width == 773 || bounds.width == 590 || bounds.width == 642 || bounds.width == 554||bounds.width == 610 || bounds.width == 558) && (bounds.height == 412 || bounds.height == 490 || bounds.height == 510)).toBe(true);
        ...
        it('Checking with vertical spacing', (done: Function) => {
            ...
            diagram.dataBind();
            let bounds: Rect = diagram.spatialSearch.getPageBounds();
            expect((bounds.x == -443 || bounds.x == -439 || bounds.x == -260) && (bounds.y == 138 || bounds.y == 93 || bounds.y == 73) &&
                    (bounds.width == 769 || bounds.width == 554 || bounds.width == 590 ||bounds.width == 610|| bounds.width == 558) && (bounds.height == 337 || bounds.height == 435 || bounds.height == 455)).toBe(true);
    ...
    to a new line\`"]
        ...
        it('Importing mindmap to cover irregular indentation and recursive node creation', (done: Function) => {
...
Root
  A
     B`;
        ...
        //     done();
        // });
        it('Importing mindmap to cover new line syntax', (done: Function) => {
            const mermaidMindmap = `mindmap
    id1[Root with
a second line
Unicode works too]
