...
- Fixed an issue where images were not positioned correctly when using first row and first column offsets during Excel export.
...
- Added support for CR LF line separator options to CSV export for improved compatibility with line breaks.

- Added support for configurable CSV text qualifier to CSV export, allowing customization of text enclosure.

- Added support for picture alignment options, enabling precise control over image positioning in exported Excel files.
