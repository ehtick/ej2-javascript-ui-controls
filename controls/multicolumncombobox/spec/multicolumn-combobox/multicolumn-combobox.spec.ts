...
describe('MultiColumnComboBox control', () => {
    ...
    describe('Basic rendering', () => {
        ...
        beforeEach((): void => {
            element = <HTMLInputElement>createElement('input', { id: 'basic_render_mccb' });
        ...
        it('check root component root class, Element Structure and get module name', (done) => {
            ...
            setTimeout(() => {
                expect(document.getElementById('basic_render_mccb').classList.contains('e-control')).toEqual(true);
                expect(document.getElementById('basic_render_mccb').classList.contains('e-multicolumncombobox')).toEqual(true);
                expect(multiColObj.element.id).toBe('basic_render_mccb');
        ...
        it('Placeholder property with dynamic value', () => {
            ...
            multiColObj.appendTo(element);
            expect(element.getAttribute('placeholder')).toEqual('Select a language');
            multiColObj.placeholder = 'new placeholder';
            multiColObj.dataBind();
            expect(element.getAttribute('placeholder')).toEqual('new placeholder');
        });
        it('HtmlAttributes property with dynamic value', () => {
            ...
            multiColObj.appendTo(element);
            const hiddenEle: HTMLSelectElement = element.parentElement.querySelector('.e-multicolumn-list-hidden');
            expect(hiddenEle.getAttribute('name')).toEqual('name-test');
            ...
            multiColObj.dataBind();
            expect(element.getAttribute('placeholder')).toEqual('attributes');
            expect(element.getAttribute('title')).toEqual('html-attributes');
        ...
        it('Checking input element name attribute', () => {
            element.setAttribute('name', 'testing_name');
            multiColObj = new MultiColumnComboBox({
                dataSource: languageData,
                fields: { text: 'text', value: 'id' },
                columns: [{ field: 'text', header: 'Language' }, { field: 'id', header: 'ID' }]
            ...
            multiColObj.appendTo(element);
            const hiddenEle: HTMLSelectElement = element.parentElement.querySelector('.e-multicolumn-list-hidden');
            expect(hiddenEle.getAttribute('name')).toEqual('testing_name');
        });
    });
    ...
    describe('Basic div rendering', () => {
        ...
        it('check ng tag and div is created', (done) => {
            ...
            multiColObj2.appendTo(ngElement);
            expect(multiColObj2.element.tagName).toBe('EJS-MULTICOLUMNCOMBOBOX');
            done();
        });
    });
    ...
    describe('Initial selection state', function () {
        ...
        it('Change event should not proceed if eventArgs.cancel is true', (done) => {
    ...
    describe('Additional Properties with initial rendering and dynamic change', () => {
        ...
        it(' width property with value alone  ', () => {
            multiColObj = new MultiColumnComboBox({
                dataSource: languageData,
                enablePersistence: true,
                fields: { text: 'text', value: 'id' },
    ...
    describe('Templates', () => {
        ...
        it(' Group template property  ', (done) => {
            ...
            (multiColObj as any).isVue = true;
            multiColObj.appendTo(element);
            setTimeout(() => {
                expect(document.querySelector('.e-group-temp').innerHTML).toBe('Group Template 1');
                expect((multiColObj as any).gridObj.isVue).toBe(true);
    ...
    describe('Value Clearing', () => {
        ...
        const valueClearingData: Object[] = [
            { CustomerID: '1001', CustomerName: 'Nirav Joshi', CustomerEmail: 'nirav@mail.com', CustomerPhone: '462-7620' },
            { CustomerID: '1002', CustomerName: 'John Smith', CustomerEmail: 'john@mail.com', CustomerPhone: '519-1783' },
            { CustomerID: '1003', CustomerName: 'Joann Isvan', CustomerEmail: 'joann@mail.com', CustomerPhone: '822-4382' },
            { CustomerID: '1004', CustomerName: 'Grady Edland', CustomerEmail: 'grady@mail.com', CustomerPhone: '695-8236' }
        ];

        beforeEach((): void => {
            element = <HTMLInputElement>createElement('input', { id: 'value-clearing-test' });
            document.body.appendChild(element);
        });
        ...
        it('should clear input and selection when value set to null with array data source', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1001',
                ...
                columns: [
                    ...
                    { field: 'CustomerEmail', header: 'Email', width: '150px' }
                ]
            });
            multiColObj.appendTo(element);
            ...
            setTimeout(() => {
                ...
                expect(multiColObj.value).toBe('1001');
                expect(multiColObj.text).toBe('Nirav Joshi');
                expect(multiColObj.index).toBe(0);
                expect((multiColObj as any).inputEle.value).toBe('Nirav Joshi');

                // Set value to null
                multiColObj.value = null;
                multiColObj.dataBind();
                // Verify cleared state
                expect(multiColObj.value).toBeNull();
                expect(multiColObj.text).toBeNull();
                expect(multiColObj.index).toBeNull();
                expect((multiColObj as any).inputEle.value).toBe('');

                done();
            }, 100);
        });

        it('should clear hidden element when value set to null', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1002',
                fields: { text: 'CustomerName', value: 'CustomerID' },
            ...
            setTimeout(() => {
                const hiddenEle = (multiColObj as any).inputWrapper.querySelector('.e-multicolumn-list-hidden') as HTMLSelectElement;
                expect(hiddenEle.value).toBe('1002');

                // Set to null
                multiColObj.value = null;
                multiColObj.dataBind();
                expect(hiddenEle.innerHTML).toBe('');
                expect(hiddenEle.value).toBe('');

                done();
            }, 100);
        });

        it('should handle rapid null assignments without errors', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1001',
                fields: { text: 'CustomerName', value: 'CustomerID' },
        ...
        it('should allow selection after clearing value with null', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1001',
                fields: { text: 'CustomerName', value: 'CustomerID' },
            ...
            setTimeout(() => {
                ...
                // Select new value
                multiColObj.value = '1003';
                multiColObj.dataBind();
                setTimeout(() => {
                    expect(multiColObj.value).toBe('1003');
                    expect(multiColObj.text).toBe('Joann Isvan');
                    expect((multiColObj as any).inputEle.value).toBe('Joann Isvan');
                    done();
                }, 100);
            }, 100);
        });

        it('should clear grid row selection when value set to null', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1004',
                fields: { text: 'CustomerName', value: 'CustomerID' },
            ...
            setTimeout(() => {
                ...
                setTimeout(function () {
                    multiColObj.showPopup();
                    setTimeout(function () {
                        const selectedRows = multiColObj.gridObj.getSelectedRows();
                        if (selectedRows.length > 0) {
                            expect(selectedRows.length).toBe(1);
                            multiColObj.value = null;
                            multiColObj.dataBind();
                            setTimeout(function () {
                                const selectedRowsAfter = multiColObj.gridObj.getSelectedRows();
                                expect(selectedRowsAfter.length).toBe(0);
                                multiColObj.hidePopup();
                                done();
                            }, 200);
                        } else {
        ...
        it('should handle null assignment when no value was previously set', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                fields: { text: 'CustomerName', value: 'CustomerID' },
                columns: [
            ...
            setTimeout(() => {
                ...
                // Set to null explicitly (should not throw)
                multiColObj.value = null;
        ...
        it('should maintain null state after popup open/close', (done) => {
            multiColObj = new MultiColumnComboBox({
                dataSource: valueClearingData,
                value: '1001',
                fields: { text: 'CustomerName', value: 'CustomerID' },
        ...
        it('should allow text property change after null value assignment', (done) => {
            ...
            setTimeout(function () {
                ...
                multiColObj.dataBind();
                expect(multiColObj.value).toBeNull();
                multiColObj.value = '1002';
                multiColObj.dataBind();
                setTimeout(function () {
                    expect(multiColObj.inputEle.value).toBe('John Smith');
                    done();
                }, 100);
            }, 100);
        });

        it('should clear input and selection when value set to null with DataManager', (done) => {
            ...
            setTimeout(() => {
                // Should have loaded initial value
                if (multiColObj.value === 'ALFKI') {
                    // Set value to null
                    multiColObj.value = null;
                    setTimeout(() => {
                        expect(multiColObj.value).toBeNull();
                    ...
                    // Skip if remote data didn't load in time
                    done();
                }
            }, 500);
        });
