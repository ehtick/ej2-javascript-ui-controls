...
describe('ExpandCollapse testing with Child Summary and without paging', () => {
  ...
  it('Collapsing using collapseRow method', () => {
    ...
    expect(rows[14].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[15].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[16].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[44].classList.contains('e-childrow-hidden')).toBe(true);               
  });
  it('Expanding using expandRow method', () => {
    TreegridObj.expandRow(null, TreegridObj.flatData[11]);
    let rows: Element[];
    rows = TreegridObj.getRows();
    expect(rows[14].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[15].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[16].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[44].classList.contains('e-childrow-visible')).toBe(true);           
  });
  it('Collapsing using collapseAll method', () => {
    ...
    expect(rows[5].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[7].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[12].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[14].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[15].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[16].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[22].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[23].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[42].classList.contains('e-childrow-hidden')).toBe(true);
    expect(rows[43].classList.contains('e-childrow-hidden')).toBe(true);
  });
  it('Expanding using expandAll method', () => {
    ...
    expect(rows[5].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[7].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[12].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[14].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[15].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[16].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[22].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[23].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[32].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[33].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[42].classList.contains('e-childrow-visible')).toBe(true);
    expect(rows[43].classList.contains('e-childrow-visible')).toBe(true);
  });
